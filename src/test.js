!function (e) {
    ...
    "use strict";
    var r = n(110), a = n(64), i = n(27), o = n(125);
    ...
    var r = n(162), a = n(46)("toStringTag"), i = "Arguments" == r(function () {
        return arguments
    }()), o = function (e, t) {
        try {
            return e[t]
    ...
    var r = n(17), a = n(103), i = n(119), o = Object.defineProperty;
    ...
    function u(e, t) {
        var n = browser.mozilla ? "keydown" : "keypress", r = (0, p["default"])({signalTimer: !1}),
            a = o.bind(null, e, t), i = l.bind(null, t, e, r), u = s.bind(null, t, r), c = (0, _.createModule)({
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = u;
    var c = n(31), d = n(113), g = n(7), m = n(43), f = n(66), p = r(f), _ = n(106)
}, function (e, t, n) {
    "use strict";
    ...
    function s(e, t) {
        var n = cn(e, t), r = n.firstElementChild.offsetHeight !== n.parentNode.offsetHeight;
        r && hn(n.firstElementChild, {height: n.parentNode.offsetHeight})
    }
    ...
    function u(e, t, n, r) {
        var a = window.devicePixelRatio >= 2 ? "256" : "128", i = "animation" === n, o = "im_gift";
        i && (o += " sticker_img");
        var s = "/images/stickers/" + Jt(e) + "/" + a + ".png",
            l = '<img height="128" class="' + o + '" src="' + s + '"/>';
        if (i) {
            var u = "/stickers.php?act=proxy_animation&product_id=" + t + "&sticker_id=" + e, c = "animatedSticker" + r;
    ...
    function d(e, t, n) {
        var r = n.randomId, a = cn("_im_mess_rid" + r, t);
    ...
    function h(e, t, n) {
        var r = v(e, t), a = cn("_im_mess_" + t.messageId, n);
        return a && (a.parentNode.replaceChild(Yt(r), a), y(n)), n
    }

    function v(e, t) {
        var n = ["_im_mess"], r = (0, yt.isUnread)(e.tabs[t.peerId], t);
        ...
        var i = b(t), o = B(e, t.text, t.kludges);
        "" != o && (0, yt.wasEdited)(t) && (o += bn("sImLblWasEdited", {update_time: t.update_time})), t.subject && "..." !== t.subject.trim() && !M(t.peerId) && (o = bn("im_topic", {topic: t.subject}) + o);
        var s = bn("im_message_media", {
            messageId: t.messageId,
            attaches: i.join(""),
            text: (0, yt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
        });
        return (0, yt.isGift)(t) || (s = o + s), "" == o && (0, yt.wasEdited)(t) && (s += bn("sImLblWasEdited", {update_time: t.update_time})), bn("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
            text: s,
    ...
    function w(e, t, n) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            i = Date.now() - 1e3 * t.date > 1e3, o = e.tabs[t.peerId];
        ...
        var d = cn("_im_unread_bar_row", n), g = (0, yt.getUserId)(t), m = c ? x(c.date, e) : 0;
        if (!c || R(o, c, t, e, a)) {
            var f = "", p = !1;
            if (d && (0, yt.isOut)(t) && qe(e, n, t.peerId), 1 === o.unread && !(0, yt.isOut)(t) && a && (f += bn("im_mess_bar", {}), p = !0, qe(e, n, t.peerId)), !An(new Date(m))) {
                var _ = new Date, h = p ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                f += bn("im_day_bar", {
            ...
            if (le(t)) f += bn("im_service_row", {
                ...
                var b = e.gid && (0, yt.isOut)(t) ? Jt(t.kludges.from_admin) || 0 : 0,
                    w = (0, Tt.oCacheGet)(e, b ? -e.gid : g) || o, E = M(t.peerId) ? w.name : w.first_name,
                    k = w.link || o.href, T = bn("im_mess_stack_name", {
                        name: E,
                        link: k,
                ...
                var A = e.gid ? "/gim" + e.gid : "/im", L = void 0;
                if (L = t.local ? N(t.date, e.timeshift) : bn("im_stack_date", {
                        date: N(t.date, e.timeshift),
                        link: A + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var P = e.admins[b], O = b === Wt.id ? yn("mail_by_you") : P[0];
                    L = L + " " + bn("im_admin_link", {name: O, href: P[1]})
                }
                f += bn("im_mess_stack", {
                    photo: w.photo,
                    href: k,
    ...
    function B(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1,
            a = Math.round(1e9 * Math.random()).toString(16), i = {}, o = 0;
        return t = (0, wt.replaceHyperLinks)(t || "", wt.linksReplacer.bind(null, r)), t = t.replace(/(<a.+?<\/a>)/gi, function (e) {
            ...
            var n = (0, pt.getGroupId)(e), r = n ? "gim" + n : "im";
    ...
    function U(e) {
        return {
            search: {name: yn("mail_im_peer_search"), icon: "search"},
            block_community: {icon: "block", name: yn("mail_block_comm_messages")},
            allow_community: {icon: "unblock", name: yn("mail_allow_comm_messages")},
            clear: {
                name: yn(e.peer < -2e9 ? "mail_im_delete_email_contact" : "mail_im_delete_all_history"),
                icon: "clear"
            },
            chat: {name: yn("mail_im_create_chat_with"), icon: "invite"},
            mute: {name: yn("mail_im_mute"), icon: "mute"},
            unmute: {name: yn("mail_im_unmute"), icon: "unmute"},
            photos: {
                name: yn(e.gid ? "mail_im_show_media_history_group" : "mail_im_show_media_history"),
                icon: "media"
            },
            avatar: {icon: "avatar", name: yn("mail_update_photo_red")},
            block: {icon: "block", name: yn("mail_block_user")},
            invite: {icon: "invite", name: yn("mail_im_create_chat_with")},
            invite_link: {icon: "invite-link", name: yn("mail_chat_invite_link")},
            leave: {icon: "leave", name: yn("mail_leave_chat")},
            topic: {icon: "topic", name: yn("mail_change_topic")},
            "return": {icon: "return", name: yn("mail_return_to_chat")},
            pin_hide: {icon: "pin_hide", name: yn("mail_menu_pin_hide")},
            pin_unhide: {icon: "pin_unhide", name: yn("mail_menu_pin_show")},
            unpin: {icon: "unpin", name: yn("mail_menu_unpin")}
        }
    }
    ...
    function V(e, t, n) {
        ...
        var r = t.data.active.slice(0, 4).map(Tt.oCacheGet.bind(null, e)), a = r.map(function (e) {
            return e.photo
    ...
    function $(e) {
        var t = e.get().popular_sugg, n = (0, pt.isClassicInterface)(e) ? 8 : 5;
        return t.length > n && (t = t.slice(0, n)), '<li class="im-popular clear_fix">' + t.map(function (t) {
            var n = t.peerId, r = (0, Tt.oCacheGet)(e, n) || t, a = e.get().tabs[n] || t,
    ...
    function ae(e, t, n, r) {
        ...
        var o = ((0, pt.isClassicInterface)(r), 60), s = ie(e, t, n, r, !1, a);
        return s.length > o ? ie(e, t, n, r, !0, a) : s
    }

    function ie(e, t, n, r, i, o) {
        var s = [], l = Object.keys(e || {}).sort(function (t, n) {
            return e[n] - e[t]
        }).filter(function (e) {
        ...
        var d = yn("mail_typing_several", l.length), g = l.slice(0, Math.min(l.length - 1, o)), m = g.map(function (e) {
            return (0, Tt.oCacheGet)(r, e)[u]
        }).join(", ");
        if (l.length > o + 1) m += " " + yn("mail_and_peer").replace("{count}", l.length - o).replace("{typing}", d); else {
    ...
    function oe(e, t, n) {
        var r = t.innerHTML, a = "delete" === n ? "mail_deleted_stop" : "mail_marked_as_spam";
    ...
    function ce(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, a = t.kludges, i = a.source_act,
            o = Jt(a.source_mid), s = t.userId, l = (0, Tt.oCacheGet)(e, s), u = "", c = s === o;
        switch (i) {
            case Dt:
        ...
        if (u = wn(l.sex, yn(u, "raw")), u = u.replace("{from}", ue(l.link, l.name, r)), o && o !== s) {
            ...
            if (d) u = u.replace("{user}", ue("/im?email=" + encodeURIComponent(d), "email", r)); else {
                var g = (0, Tt.oCacheGet)(e, o), m = i === Nt ? g.inv_name : g.kick_name;
        ...
        if (a.source_act === Ht || a.source_act === jt) if (a.source_message) {
    ...
    function fe(e, t) {
        return Dn(e, {
            ...
            params: {act: "verified_tt", mid: t, gid: t},
            slide: 15,
            ajxdt: 200,
            showdt: 200,
            hidedt: 200,
    ...
    function pe(e) {
        return function (t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "", a = Yt(bn("im_preloader", {
                    preloader: Xt(Wt.pr_tpl, {id: ""}),
    ...
    function he(e, t) {
        if (!t && !e) return !1;
        var n = e.target || e.srcElement, r = Vn, a = !1,
            i = /_im_mess|im_log_act|im_log_ract|_im_log_body|im_log_rspacer|_im_graffiti_w|_wall_post_cont/;
        do if (!n || n.onclick || n.onmousedown || "A" == n.tagName || pn(n, "_im_no_select") || pn(n, "im_msg_media_link") || "IMG" == n.tagName && !pn(n, "_im_graffiti") && !pn(n, "emoji") && !pn(n, "emoji_css") && !pn(n, "im_gift") || "TEXTAREA" == n.tagName || pn(n, "play_new") || pn(n, "videoplayer") || (a = i.test(n.className))) break; while (r-- && (n = n.parentNode));
        return a ? !!en(ve()) : !0
    }
    ...
    function ke(e, t, n, r, a) {
        var i = e.get().peer;
        Un(r), Ln("al_im.php", {act: "a_show_members_box", chat: i - 2e9}, {
            stat: ["boxes.css"],
            params: {dark: 1},
            onDone: function (r, a) {
                var i = (0, Et.createModule)({
                    handlers: function (a, o) {
                        o(r.bodyNode.parentNode, "click", "_im_invite_box", function () {
                            ...
                            var n = cn("_im_chat_members_w", r.bodyNode.parentNode), a = 160,
                                i = dn("_im_member_item", t), o = i.offsetTop - n.scrollTop + a, s = o > 370;
                            xn(t, {
                                was: Jt(ln(t, "was")),
                                mid: Jt(ln(t, "peer")),
    ...
    function Te(e, t, n, r) {
        var a = e.get().tabs[t], i = a.memberIds;
    ...
    function xe(e, t, n) {
        var r = void 0;
        return !On("al_im.php", {act: "a_spam", offset: "0", gid: e.get().gid}, {
            onDone: function (n, a) {
                a && (r = t(n, e, a))
            }, params: {
                width: 638, onHide: function () {
    ...
    function Ne(e, t, n, r) {
        var a = n ? "" : 'onclick="mobilePromo();"', i = n ? ", vk_mobile: 1" : "", o = n ? " vk_mobile" : "";
    ...
    function Be(e, t) {
        var n = t.get().tabs[e];
        return Ln("al_settings.php", {act: "blacklist_box", q: n.href}, {
    ...
    function Fe(e, t) {
        return Ln("groupsedit.php", {
            ...
            name: "/id" + e,
            gid: t.get().gid
        }, {stat: ["page.css", "ui_controls.js", "ui_controls.css"], dark: 1})
    }
    ...
    function je(e, t, n, r) {
        var a = void 0, i = On("al_im.php", {act: "a_important", offset: "0"}, {
            onDone: function (r, i) {
                i && (a = n(r, e, t, i))
            }, params: {
                width: 638, onHide: function () {
    ...
    function qe(e, t, n) {
        ...
        if (!r) return t;
        var a = sn(r, "._im_mess_stack", -1), i = sn(r, "._im_mess_stack"), o = a ? un("_im_mess", a).pop() : null,
            s = i ? cn("_im_mess", i) : null;
        if (Qt(r), _(t), !s || !o) return t;
        var l = ln(s, "msgid"), u = (0, pt.getPreviousMessage)(e, n, l), c = (0, pt.getMessage)(e, n, l);
        if (!u || R(e.tabs[n], u, c, e)) return t;
        var d = cn("_im_stack_messages", a), g = cn("_im_stack_messages", i).children;
    ...
    function ze(e, t, n) {
        ...
        if (!o) return [!0, 0];
        var s = a ? a.offsetTop : 0, l = o.offsetTop + s, u = n.contHeight();
    ...
    function Qe(e, t, n, r, a) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, wt.replaceMentions)(n, function (e, t, n, r, a) {
            ...
            topic: t,
            cls: "im-topic_dialog"
        }) + n), !n && a.length > 0 && (n = bn("im_dialog_media", {name: Xe(a[0], a)})), n
    }
    ...
    function Je(e) {
        var t = e.get(), n = (0, pt.getPinnedMessage)(e);
        if (!n || !(0, St.isPinnedMessageVisibleInTab)(e, (0, pt.getPeer)(e))) return "";
        var r = (0, Tt.oCacheGet)(e, n.userId);
        if (!r) return "";
        var a = et(e, n);
        a || (a = n.text, a = !a && n.attaches.length ? bn("im_pinned_message_media", {text: Xe(n.attaches[0], n.attaches)}) : B(e, a, n && n.kludges || {}) || ""), a = a.replace(/<br\s?\/?>/gi, " ");
        var i = bn("im_pinned_message", {date: Tn(n.date, t.timeshift), content: a, link: r.link, name: r.name});
        return i
    }
    ...
    function et(e, t) {
        ...
        if (t && (0, yt.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
            ...
            t.kludges.attach1_total_amount && (n += bn("im_pinned_message_media_bar", {percent: Math.min(100, Math.floor(t.kludges.attach1_tr_amount / t.kludges.attach1_total_amount * 100))}))
        }
        return n
    }
    ...
    function at(e, t, n, r, a) {
        var i = e.get(), o = void 0, s = On("al_im.php", {
    ...
    function st(e, t) {
        var n = (0, Tt.oCacheGet)(e, t.peerId), r = (0, pt.getTab)(e, t.peerId) || {};
    ...
    function ut(e, t) {
        var n = [], r = t.find(function (e) {
            return "mail" === e[0]
        }), a = r ? r[1].split(";") : [];
        for (a.length > zn && (r[1] = a.slice(0, zn).join(";")); e.length > qn;) {
            var i = e.substr(0, qn).lastIndexOf(" ");
            -1 == i && (i = qn), n.push({msgText: en(e.substr(0, i))}), e = en(e.substr(i))
        }
        for (e.length && n.push({
            msgText: e,
            attaches: t
        }), n.length || n.push({attaches: t}), a = a.slice(zn); a.length; a = a.slice(zn)) n.push({attaches: [["mail", a.slice(0, zn).join(";")]]});
        return n
    }
    ...
    function dt(e, t, n) {
        var r = !1;
        Ln("al_im.php", {act: "a_chat_preview", chat_id: t.invite_chat_id, hash: t.invite_hash}, {
            stat: ["boxes.css"],
            params: {
                dark: 1, hideButtons: !0, onHide: function () {
                    e.set(n), r && r.unmount()
                }
            },
            onFail: function (e) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.PINNED_CONTAINER_CLASS = t.MESSAGE_SEARCH_CLASS = t.CLEAR_RECENT_CLASS = t.INSTALL_VKADMIN_LINK = t.HIDE_ASIDE_PROMO_BLOCK_CLASS = t.HIDE_ASIDE_NOTICE_CLASS = t.HIDE_TOP_NOTICE_CLASS = t.SHOW_CHAT_MEMBERS_CLASS = t.DESELECT_ALL_CLASS = t.CHAT_INVITE_BY_LINK = t.CHAT_UNPIN_MESSAGE = t.CHAT_PIN_MESSAGE = t.CHAT_PHOTO_REMOVE = t.CHAT_PHOTO_UPDATE = t.CHAT_KICK_USER = t.CHAT_INVITE_USER = t.CHAT_TITLE_ACTION = t.CREATE_CHAT_ACTION = t.TYPING_CLASS = t.RESTORE_CLASS = t.ORIGINAL_CLASS = t.FAILED_CLASS = t.SENDING_CLASS = void 0;
    ...
    var _t = n(43), ht = r(_t), vt = n(31), bt = r(vt), yt = n(92), wt = n(118), Ct = n(150), Et = n(106), kt = n(30),
        Tt = n(121), St = n(77), It = n(132), At = n(113), Mt = t.SENDING_CLASS = "_im_mess_sending",
        Lt = t.FAILED_CLASS = "_im_mess_failed", Pt = t.ORIGINAL_CLASS = "_im_mess_original",
        Ot = t.RESTORE_CLASS = "_im_mess_restore",
        Dt = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
        xt = t.CHAT_TITLE_ACTION = "chat_title_update", Rt = t.CHAT_INVITE_USER = "chat_invite_user",
        Nt = t.CHAT_KICK_USER = "chat_kick_user", Bt = t.CHAT_PHOTO_UPDATE = "chat_photo_update",
        Ft = t.CHAT_PHOTO_REMOVE = "chat_photo_remove", Ht = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        jt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message", Ut = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        ...
        qt = t.MESSAGE_SEARCH_CLASS = "_im_mess_search", zt = t.PINNED_CONTAINER_CLASS = "_im_pinned", Vt = window,
        Wt = Vt.vk, Kt = Vt.ls, Yt = Vt.se, Qt = Vt.re, Xt = Vt.rs, $t = Vt.sech, Zt = Vt.inArray, Jt = Vt.intval,
        en = Vt.trim, tn = Vt.stripHTML, nn = Vt.domFC, rn = Vt.domPS, an = Vt.domLC, on = Vt.domChildren,
        sn = Vt.domClosestSibling, ln = Vt.domData, un = Vt.geByClass, cn = Vt.geByClass1, dn = Vt.gpeByClass,
        gn = Vt.addClass, mn = Vt.removeClass, fn = Vt.toggleClass, pn = Vt.hasClass, _n = Vt.attr, hn = Vt.setStyle,
        vn = Vt.val, bn = Vt.getTemplate, yn = Vt.getLang, wn = Vt.langSex, Cn = Vt.langDate, En = Vt.langNumeric,
        kn = Vt.getDateText, Tn = Vt.getSmDate, Sn = Vt.getShortDate, In = Vt.isSameDate, An = Vt.isToday, Mn = Vt.ajax,
        Ln = Vt.showBox, Pn = Vt.showFastBox, On = Vt.showTabbedBox, Dn = Vt.showTooltip, xn = Vt.mobileOnlineTip,
        Rn = Vt.mobPlatforms, Nn = Vt.onlinePlatformClass, Bn = Vt.AudioMessagePlayer, Fn = Vt.Emoji, Hn = Vt.slideUp,
        jn = Vt.fadeOut, Un = Vt.cancelEvent, Gn = Vt.ny2018ReplaceText, qn = 4096, zn = 100, Vn = 8, Wn = 52,
        Kn = "chatPosition"
}, function (e, t, n) {
    "use strict";

    function r() {
        return {txt: "", attaches: [], urlBinds: []}
    }
    ...
    function s(e) {
        return {txt: e.txt, attaches: e.attaches || [], urlBinds: e.urlBinds || []}
    }

    function l(e, t) {
        var n = [];
        e.fwd_count ? n.push({type: "mail", id: -t, object: {fwd_count: e.fwd_count}}) : e.fwd && n.push({
            type: "mail",
            id: -t,
            object: {fwd_count: (0, g.parseFwd)(e.fwd).length}
        });
        ...
        return e.geo && n.push({type: "geo", id: e.geo}), n
    }
    ...
    a.prototype.dump = function () {
        ...
        !r && e && t && (this.dData.attaches.push({type: e, id: t, object: n}), this.dump())
    }, a.prototype.syncWithSelector = function (e) {
        var t = this, n = this.getFwdRaw();
        this.dData.attaches = (n ? [n] : []).concat(e.getMedias().map(function (e) {
            var n = c(e, 2), r = n[0], a = n[1], i = t.dData.attaches.find(function (e) {
                return e.type == r && e.id == a
            });
            return i || {type: r, id: a}
        })), this.dump()
        ...
        this.getBoundAttach(e) || (this.dData.urlBinds.push({url: e, type: t, id: n}), this.dump())
        ...
        var n = this, r = this.dData.attaches.find(i);
        return r ? (0, d.post)(d.CONTROLLER, {
            ...
            n.dData.attaches = r.map(function (e) {
                return {type: e[0], id: e[1], object: e[2]}
            })
        }) : Promise.resolve()
    ...
    var r = n(159), a = "__core-js_shared__", i = r[a] || (r[a] = {});
    e.exports = function (e) {
        return i[e] || (i[e] = {})
    }
}, , function (e, t, n) {
    ...
    function s(e, t) {
        return Promise.resolve(extend({}, t, {timeout: 64 > e ? 2 * e : e}))
    }

    function l(e, t) {
        return Promise.resolve(extend({}, t, {imTs: e}))
    }

    function u(e) {
        e.set(function (e) {
            return Promise.resolve(extend({}, e, {stopped: !0}))
        }).then(function () {
            e.get().cancelToken()
        })
    }
    ...
    function m(e, t, n, r) {
        var a = r.failed ? (0, k.abortablePause)(A, e) : {}, i = a.abort, o = a.pause;
        switch (r.failed) {
            case 1:
            ...
            case 3:
                throw nav.reload({force: !0}), new Error("ts is very wrong");
            default:
    ...
    function f(e, t, n) {
        if (e.get().stopped) return Promise.resolve({updates: []});
        if (t()) return Promise.reject(new Error("pause"));
        var r = e.get(), a = r.imUrl + "/" + r.imPart, o = (0, w.plaingetCancelable)(a, {
            act: "a_check",
            key: r.imKey,
            version: M,
            ts: r.imTs,
            wait: 25,
            mode: r.mode
        }), l = o.request, u = o.cancel;
        return e.set(c.bind(null, u)).then(function () {
            return l
        }).then(function (t) {
            var n = h(t, 2), a = n[0], o = n[1];
    ...
    function p(e, t, n) {
        e.get().stopped || ((0, S.lplog)("New request"), f(e, n, t).then(o).then(function (e) {
            ...
            return e.get().stopped ? void(0, S.lplog)("Stopped longpoll") : ("pause" !== t.message && topError(t), (0, S.lplog)("Error, waiting: " + (t.message || "no message (probably browser reset)"), "error"), e.set(s.bind(null, n() ? A / 2 : e.get().timeout)).then(function () {
                var t = (0, k.abortablePause)(e.get().timeout, e), n = t.abort, r = t.pause;
    ...
    function _(e) {
        var t = e.id, n = e.gid, r = e.key, a = e.ts, i = e.url, o = e.lhost, s = e.lpstat, l = "main",
            c = new EventEmitter, d = (0, T.initQueue)(function (e, t) {
                return c.trigger("data", t), Promise.resolve({})
            }), m = d.pause, f = d.resume, _ = d.pushMessage, h = d.isPaused, v = d.reset, b = (0, y["default"])({
                id: t,
                gid: n,
                mode: I,
                timeout: 1,
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.eventTypes = void 0;
    var h = function () {
        function e(e, t) {
            var n = [], r = !0, a = !1, i = void 0;
            try {
    ...
    t.startLongPoll = _;
    var v = n(113), b = n(66), y = a(b), w = n(33), C = n(43), E = r(C), k = n(63), T = n(28), S = n(30),
        I = (t.eventTypes = E, 202), A = 4, M = 4, L = 3e4, P = {}, O = Date.now()
}, function (e, t, n) {
    "use strict";
    ...
    function g(e, t, n) {
        var l = geByClass1(h, e), g = geByClass1(v, e), m = i.bind(null, t, n, g), p = r(t, e, l, m),
            C = o.bind(null, p, e), E = u.bind(null, t, g, l, n, debounce(s, 300)), k = c.bind(null, t, g, n, p),
            T = d.bind(null, t, n, p, g), S = (0, f.createModule)({
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = g;
    var m = n(113), f = n(106), p = "im_hist_search", _ = "_im_search_date", h = "_im_search_date_input",
        v = "_im_search_history_input", b = "_im_start_inplace_search", y = "_im_cancel_inplace_search",
        w = "_im_clear_date"
}, function (e, t, n) {
    "use strict";
    var r = n(80), a = n(122), i = n(42), o = n(40), s = n(129), l = n(27), u = n(60), c = n(149), d = n(21),
        g = n(46)("iterator"), m = !([].keys && "next" in [].keys()), f = "@@iterator", p = "keys", _ = "values",
        h = function () {
            return this
        };
    e.exports = function (e, t, n, v, b, y, w) {
        ...
        var C, E, k, T = function (e) {
            ...
            }, S = t + " Iterator", I = b == _, A = !1, M = e.prototype, L = M[g] || M[f] || b && M[b], P = L || T(b),
            O = b ? I ? T("entries") : P : void 0, D = "Array" == t ? M.entries || L : L;
        if (D && (k = d(D.call(new e)), k !== Object.prototype && (c(k, S, !0), r || s(k, g) || o(k, g, h))), I && L && L.name !== _ && (A = !0, P = function () {
                return L.call(this)
            }), r && !w || !m && !A && M[g] || o(M, g, P), l[t] = P, l[S] = h, b) if (C = {
                values: I ? P : T(_),
                keys: y ? P : T(p),
                entries: O
            }, w) for (E in C) E in M || i(M, E, C[E]); else a(a.P + a.F * (m || A), t, C);
        return C
    }
}, , function (e, t) {
    "use strict";
    ...
    function n(e, t) {
        var n = void 0, r = void 0, a = function (a) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.initDraggable = n, t.removeDraggable = r
}, function (e, t) {
    e.exports = function (e) {
    ...
    e.exports = function (e) {
        return function (t, n) {
            var i, o, s = String(a(t)), l = r(n), u = s.length;
    ...
    var r = n(129), a = n(90), i = n(87)("IE_PROTO"), o = Object.prototype;
    ...
    function i(e) {
        return e.map(function (e) {
            return {id: e[1], type: e[0], kind: e[2] || null}
        })
    }
    ...
    function o(e, t, n, r, a, o) {
        ...
        var l = (0, z.random)(), u = {
            ...
            local: !0,
            kludges: {emoji: !0, from_admin: r.get().gid ? vk.id : null},
            type: F.ADD_MESSAGE,
    ...
    function l(e, t, n) {
        ...
        return r.skipped > 0 ? (t().loadingPeer(e), e.setState({no_moving_down: !0}), e.set(j.changePeer.bind(null, e.get().peer, !1)).then(function () {
            return e.set(j.loadPeer.bind(null, e.get().peer, !0, -1, !1))
        }).then(function () {
            return t().changePeer(e, !1), e.setState({no_moving_down: !1}), n
        })) : Promise.resolve(n)
    }
    ...
    function d(e, t) {
        document.activeElement && document.activeElement.blur(), showFastBox({title: getLang("global_error")}, getLang("mail_send_error"), getLang("mail_ok"), function () {
            nav.reload({force: !0})
        });
    ...
    function m(e, t, n, r, a, i) {
        var s = arguments, u = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : [];
        return Promise.resolve().then(function () {
            ...
            return m.then(l.bind(null, e, t)).then(function () {
                var r = g(e), i = r.dData.attaches.map(function (e) {
                    return [e.type, e.id]
                }).concat(u), s = r.dData.txt;
                if (s || i.length) {
                    ...
                    var c = (0, U.splitMessageToParts)(s, i), d = c.map(function (r) {
                        return o(n, f, {message: r.msgText || "", attaches: r.attaches || []}, e, t, a)
                    });
    ...
    function _(e, t, n, r, a, i, o) {
        function s(n, r) {
            var a = e.get().peer, i = Emoji.val(r);
        ...
        var l = void 0, u = debounce(I.bind(null, e, n), 500), c = Emoji.init(geByClass1("_im_text", t), {
            ttDiff: 93, rPointer: !0, onSend: function () {
                return r([])
            }, controlsCont: t, forceTxt: !e.get().editable, checkEditable: s, onStickerSend: function (e, t, n) {
                return a([["sticker", e, n]], {sticker_referrer: t})
            }, uploadActions: i
        });
        return Emoji.emojiLoadMore(c), e.setState({emojiOptId: c}), c
    }
    ...
    function b(e, t, n) {
        (0, G.isAnyMessageBeingEdited)(e) || O(e, t).then(function (t) {
            ...
            if ((2 === r && t !== !0 || 1 === r && t === !0) && window.tooltips && tooltips.destroy(n.target, {fasthide: !0}), t !== !0) return domData(n.target, "tttype", 1), showTooltip(n.target, {
            ...
            return showTooltip(n.target, {
                ...
                appendParentCls: "_im_chat_input_parent",
                onCreate: function () {
                    radioBtns.im_submit = {els: (0, V.toArray)(geByClass(pe)), val: a}
                }
            })
        })
    }
    ...
    function C(e, t, n) {
        var r = e.getFwdRaw(), a = geByClass1(me, t);
        if (r) if (r.object && r.object.authorName) {
            var i = r.object,
    ...
    function k(e, t, n, r, a, i, o, s, l, u) {
        return {
            restoreDraft: function (e, a) {
                t.chosenMedias.length > 0 && (e.setState({removingMedias: !0}), t.unchooseMedia(), t.chosenMedias = [], e.setState({removingMedias: !1}));
                var o = e.get().peer, s = (0, U.isUserPeer)(o) && o != vk.id && !e.get().gid,
                ...
                e.setState({tfdraft: t}), t && this.restoreDraft(e, i().getEditingMessage())
    ...
    function I(e, t, n) {
        var r = e.get().peer, a = Emoji.val(n);
    ...
    function M(e) {
        var t = g(e).getFwdRaw();
        t && window.showForwardBox({act: "a_show_forward_box", will_fwd: t.id, gid: e.get().gid})
    }
    ...
    function P(e, t, n) {
        var r = gpeByClass("_im_chat_input_parent", n), a = geByClass1("_im_chat_input_error", r);
        if (S(t, e)) {
            n.disabled = !0;
    ...
    function D(e, t, n) {
        ...
        a(r, {fasthide: !0}), O(e, t, n).then(function (t) {
            if ((0, G.isAnyMessageBeingEdited)(e)) toggleClass(r, "is_input_empty", !t), attr(r, "aria-label", getLang("mail_im_edit")); else {
    ...
    function N(e, t, n) {
        ...
        var r = (0, W.createMutations)(k), i = r.callMutations, o = r.bindMutations, l = (0, K.mount)(e, t, i),
            c = f.bind(null, t);
        ls.remove("im_send_queue_2" + vk.id), ls.remove("im_send_queue_1" + vk.id);
        var d = (0, q.initQueue)(c, p.bind(null, t), {store: "ls", key: "im_send_queue_" + vk.id, waitCommit: !0}),
            g = d.pushMessage, y = d.inspectQueue, w = d.resend, C = d.setErrored, T = d.complete,
            S = s.bind(null, t, n, g, i, e), I = M.bind(null, t);
        hide(geByClass1("ms_items_more_helper", e));
        var A = [["video", getLang("profile_wall_video")], ["audio", getLang("profile_wall_audio")], ["doc", getLang("profile_wall_doc")], ["map", getLang("profile_wall_map")], ["gift", getLang("profile_wall_gift")]];
        ...
        var L = new MediaSelector(geByClass1(de, e), _e, A, {
                ...
                docParams: t.get().gid ? {imhash: t.get().upload_doc_opts.opts.imhash, from: "from_gim"} : {}
            }), P = m.bind(null, t, n, g, e, i, L), D = b.bind(null, t, e), N = geByClass1("_im_send", e),
            B = s.bind(null, t, n, g, i, e), U = (0, H.mount)(e, t, B, function () {
        ...
        var V = E.bind(null, t, e, n), Y = u.bind(null, t), Q = (0, W.createModule)({
            handlers: function (r, o) {
                r(N, "click", function () {
                    O(t, e).then(function (e) {
                        e || (0, G.isAnyMessageBeingEdited)(t) ? P([]) : (a(N, {fasthide: !0}), U.start(), setTimeout(function () {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = N;
    var B = n(43), F = r(B), H = n(71), j = n(113), U = n(7), G = n(152), q = n(28), z = n(116), V = n(30), W = n(106),
        K = n(145), Y = n(132), Q = n(8), X = n(121), $ = 4, Z = 5, J = 6, ee = 7, te = 9, ne = 11, re = 12, ae = 13,
        ie = 14, oe = 16, se = 19, le = 20, ue = 23, ce = 2e3, de = "_im_media_selector", me = "_im_media_fwd",
        fe = "_im_fwd_close", pe = "_im_submit_btn", _e = "_im_media_preview"
}, function (e, t) {
    function n() {
    ...
    function o(e, t, n, r) {
        if (n) {
            s(e, t, r);
            var i = domData(n, "list-id"), o = i && a(t.children, i);
            o && r.forEach(function (e) {
                return addClass(o, e)
            }), e.setState({hoveredListItemId: i})
        }
    }
    ...
    function s(e, t, n) {
        ...
        }), e.setState({hoveredListItemId: null})
    }
    ...
    function c(e, t, n) {
        ...
        return {_sortedEls: !1, els: r, ids: u(r, t, n.ids), elements: n.elements.concat(r)}
    }

    function d(e, t, n) {
        return {ids: u(n.get().elements, e, {}), scrolls: t, activated: !0}
    }
    ...
    function m(e, t, n) {
        ...
        n.elements = n.elements.map(function (n) {
            var a = t(n), i = e.filter(function (e) {
                return t(e) === a
            })[0];
            return r.push(a), i || n
        });
    ...
    function f(e, t) {
        var n = t.get();
        return !n._sortedEls && e && t.setState({elements: n.elements.sort(e), _sortedEls: !0}), t.get().elements
    }
    ...
    function v(e, t, n, r) {
        if (0 !== t.length) {
            ...
            if (i.map(function (t) {
                    ...
                    return re(e)
                }), 0 !== a.length) for (var o = a.shift(), s = o[2], l = h(e.children[s], n[o[2]], o[1], 0, r, e), u = 0; u < a.length; u++) o = a[u], l = h(e.children[s], n[o[2]], o[1], o[2] - s, r, e), s = o[2]
        }
    }
    ...
    function y(e, t, n, r, a) {
        var i = r.get(), o = i.limit, s = i.offset, l = n().sortFn, u = f(l, r).slice(0, s + o),
    ...
    function w(e, t, n, r) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !1,
            ...
            s = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0, l = e.get(),
            u = t.getContainer().children, c = i(u, r || l.hoveredListItemId);
        if (!(0 > c)) {
            var d = void 0;
            d = l.limit + l.offset < c ? e.setState({offset: c - l.limit + 1}).then(y.bind(null, t.getContainer(), t, n)) : Promise.resolve(), d.then(function () {
                var e = u[c], n = t.scrollTop(), r = t.getScrollHeight(), i = e.offsetHeight;
                o = "center" === o ? -.5 * t.getScrollHeight() : o, s = "center" === s ? r / 2 : s;
                var l = a ? function (e) {
                    t.smoothScroll(e - t.scrollTop())
                } : t.scrollTop.bind(t), d = n + o > e.offsetTop, g = i + e.offsetTop > n + r - s;
    ...
    function k(e, t, n, r) {
        var a = e.get(), i = a.elements, o = r.getContainer(),
            s = e.setState({offset: a.offset + a.limit}).then(function (n) {
                var s = a.offset, l = a.limit, u = void 0;
                return l + s > i.length ? u = t().more(s, l).then(function (t) {
                    return t === !1 ? [] : (0 === t.length && e.setState({stop: !0}), t)
    ...
    function I(e, t, n) {
        var c = C.bind(null, t, k.bind(null, t, n)), f = function (e, r) {
            (t.get().activated || e) && ("undefined" != typeof r && t.get().elements.length > 0 && t.setState({scrolled: r}), n().onScroll && n().onScroll())
        ...
        return t.setState(d(n().idFn, {}, t)), {
            pipe: function (e, r) {
                return t.setState({pipeId: r}), e.then(S.bind(null, t, p.getContainer(), p, n, r))
                ...
                return t.setState({pipeId: r, stop: !1}), e.then(function (e) {
                ...
                t.setState({activated: !1})
            }, activate: function () {
                t.setState({activated: !0})
                ...
                var n = t.get().scrolls, a = n[e];
                return a && (t.setState({scrolls: extend({}, n, r({}, e, null))}), p.scrollTop(a.scrolled)), !!a
            }, unsetScroll: function (e) {
                t.setState({scrolls: extend({}, t.get().scrolls, r({}, e, null))})
            }, scrollPage: function (e, t) {
                var n = p.scroll.scroller, r = p.scrollTop(), a = "up" === e ? -1 : 1, i = r + a * n.clientHeight;
                ...
                var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, s = p.getContainer(),
                    u = s.children, c = t.get().hoveredListItemId || l(s, r), d = i(u, c),
                ...
                var a = p.getContainer(), i = a.children, s = (0, M.toArray)(i).findIndex(n().hoverableFn), l = i[s];
                !t.get().hoveredListItemId && l && (o(t, a, l, e), w(t, p, n, s, !1, r.top, r.bottom))
            }, hoverElement: function (e, r, a) {
                var s = p.getContainer(), l = s.children, u = i(l, e), c = l[u];
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.createIdMap = u, t.addElements = c, t.collapseOps = p, t.distance = _, t.mount = I;
    var A = n(7), M = n(30), L = n(151), P = n(106)
}, function (e, t) {
    e.exports = function (e) {
    ...
    function o(e) {
        for (var t = {}, n = Object.keys(e.queues), r = n.length, a = 0; r > a; a++) {
            var i = n[a], o = e.queues[i];
            (o.currEv || o.evs.length || o.errored.length) && (t[i] = o)
        }
        return {queues: t, opts: e.opts}
    }
    ...
    function u(e, t, n, r) {
        ...
        if (o && !o.currEv && o.evs.length > 0 && !o.pause) {
            var s = u.bind(null, e, t, n, r), c = o.evs.shift();
    ...
    function d() {
        return {evs: [], pause: !1, errored: [], currEv: !1}
    }
    ...
    function _(e, t, n) {
        var r = (0, v["default"])({queues: {}, debug: n && n.debug, opts: extend({}, n)}, n);
        return n && n.store ? (r.setState(o(r.get())), p(r)) : p(r), {
            pushMessage: function (n, a) {
                ...
                var n = r.get().queues[e], a = t && n.currEv ? [n.currEv] : [];
                return a.concat(n.evs.slice()).concat(n.errored.slice().map(function (e) {
                    return extend({}, e, {failed: !0})
                })).sort(function (e, t) {
                    return e.ts - t.ts
                })
            }
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.initQueue = _;
    var h = n(66), v = r(h), b = n(63)
}, function (e, t, n) {
    "use strict";
    var r = n(147);
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.throttleAccumulate = n, t.executionStackPop = r, t.lplog = a, t.toArray = i, t.arrayUnique = o, t.urlBase64ToUint8Array = s
}, function (e, t) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {value: !0});
    var r, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј", i = "(https?:\\/\\/)?", o = "((?:[" + a + "\\—\\-\\_]+\\.){1,5})",
        s = "([A-Za-z\\$а-яА-Я\\-\\d]{2,22})", l = "(?:\\:(\\d{2,5}))", u = "(" + o + s + l + "?)", c = "([\\/?#])",
        ...
        E = t.ARROW_DOWN = 40, k = t.PAGE_UP = 33, T = t.PAGE_DOWN = 34, S = t.END_KEY = 35, I = t.HOME = 36,
        A = t.ENTER = 13, M = t.ESC = 27,
        L = (t.UNPRINTABLE_KEYS = [C, E, k, T, A, M, S, I], t.UP_DOWN_CONTROLS = [k, T, E, C, I, S], t.PRINTABLE = "printable", t.FOLDER_UNREAD = "unread"),
        P = t.FOLDER_ALL = "all", O = t.FOLDER_UNRESPOND = "unrespond", D = t.FOLDER_IMPORTANT = "important",
        ...
        N = "a-zA-Zа-яА-ЯёіјєїґўЁІЈЄЇҐЎ’", B = "(?:&#(?:19[2-9]|(?:[2-9]|1[0-3])[0-9][0-9]);?)",
        F = "(?:[" + N + "]|" + B + ")", H = "(?:[" + N + "_\\d]|" + B + ")",
    ...
    function n(e, t, n) {
        return t && (t.im_v = i), new Promise(function (r, a) {
            ajax.post(e, t, {
                timeout: n, onDone: function () {
                    r.apply(null, [[].concat(Array.prototype.slice.call(arguments))])
                }, onFail: function () {
    ...
    function r(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = a(e, t, n), i = r.request;
        return i
    }
    ...
    function a(e, t) {
        ...
        var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a = void 0;
        a = window.XDomainRequest ? new XDomainRequest : ajax._getreq();
        var i = new Promise(function (n, i) {
            var o = void 0, s = Date.now(), l = r.timeout || 60, u = ajx2q(t);
        ...
        return {request: i, cancel: n}
    }

    Object.defineProperty(t, "__esModule", {value: !0}), t.post = n, t.plainget = r, t.plaingetCancelable = a;
    var i = (t.CONTROLLER = "al_im.php", 2)
}, function (e, t) {
    "use strict";
    Array.prototype.findIndex || Object.defineProperty(Array.prototype, "findIndex", {
        value: function (e, t) {
            for (var n = 0; n < this.length; ++n) if (e.call(t, this[n], n, this)) return n;
            return -1
        }
    }), Array.prototype.find || Object.defineProperty(Array.prototype, "find", {
        value: function (e, t) {
            for (var n = 0; n < this.length; ++n) if (e.call(t, this[n], n, this)) return this[n]
        }
    })
}, function (e, t) {
        ...
        if (!e.loading && !e.all) {
            ...
            if (a > -300) {
                ...
                e.loading = !0, (0, d.wrapLoading)(i)((0, l.loadImportant)(e.offset).then(function (t) {
                    var n = s(t, 4), a = (n[0], n[1]), o = (n[2], n[3]);
    ...
    function o(e, t, n, r) {
        var o = ge("box_layer_wrap"), s = t.get().longpoll,
            l = (0, m["default"])({peer: 0, longpoll: s, oCache: {}, tabs: (0, d.tabFromIds)(r.msgs, r.hash)}),
        ...
        s.on("data", _);
        var h = a.bind(null, {all: !1, loading: r.all, offset: r.offset}, e, o, l), v = (0, f.createModule)({
            handlers: function (e, t) {
                e(o, "scroll", h)
            }
        });
    ...
    t.mount = o;
    var l = n(113), u = n(44), c = n(143), d = n(7), g = n(66), m = r(g), f = n(106), p = n(43)
}, function (e, t, n) {
    "use strict";
    var r = n(159), a = n(5), i = n(154), o = n(46)("species");
    e.exports = function (e) {
        var t = r[e];
        i && t && !t[o] && a.f(t, o, {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.initFailBack = n
}, function (e, t, n) {
    "use strict";
        ...
        if (!e.loading && !e.all) {
            ...
            if (a > -300) {
                ...
                e.loading = !0, (0, h.wrapLoading)(i)((0, _.loadSpam)(e.offset, r.get().gid).then(function (t) {
                    var n = p(t, 4), a = (n[0], n[1]), o = (n[2], n[3]);
    ...
    function o(e, t) {
        var n = t.get().selectedMessages, r = geByClass1("_im_spam_box", e.bodyNode),
    ...
    function c(e, t, n) {
        ...
        (0, _.removeMessageSend)(r, 0, e.get().tabs[0].hash, "nospam", e.get().gid), r.map(function (e) {
            ...
            var t = intval(domData(e, "peer")), n = intval(domData(e, "msgid"));
            val(e, (0, h.renderGoTo)(t, n)), addClass(e, "im-mess_light")
        }), s(e, t, n)
    }

    function d(e, t, n, r, a) {
        var i = gpeByClass("_im_mess", a, t.bodyNode), o = intval(domData(i, "peer")), s = intval(domData(i, "msgid"));
    ...
    function f(e, t, n) {
        var r = ge("box_layer_wrap"), i = (0, v.createMutations)(m), f = i.callMutations, p = i.bindMutations,
            _ = (0, w["default"])({peer: 0, oCache: {}, tabs: (0, h.tabFromIds)(n.msgs, n.hash), gid: t.get().gid}),
            y = a.bind(null, {all: n.all, loading: !1, offset: n.offset}, e, r, _), C = l.bind(null, _, e.bodyNode),
            T = d.bind(null, t, e, f), S = g.bind(null, n.hash, e, f, t.get().gid),
            I = (0, b.mount)(e.bodyNode, _, function (t) {
                return {changedMessageSelection: o.bind(null, e)}
            }), A = u.bind(null, _, e.bodyNode, I), M = c.bind(null, _, e.bodyNode, I), L = s.bind(null, _, e, I);
    ...
    t.mount = f;
    var _ = n(113), h = n(7), v = n(106), b = n(67), y = n(66), w = r(y), C = n(43), E = "_im_spam_not_spam",
        k = "_im_spam_spam"
}, function (e, t, n) {
    var r = n(5), a = n(75);
    ...
    var r = n(17), a = n(107), i = n(59), o = n(87)("IE_PROTO"), s = function () {
    }, l = "prototype", u = function () {
        var e, t = n(82)("iframe"), r = i.length, a = ">";
    ...
    var r = n(159), a = n(40), i = n(129), o = n(56)("src"), s = "toString", l = Function[s], u = ("" + l).split(s);
    ...
    function a(e) {
        var t = N(e, 2), n = t[1];
        return {type: j, localId: n}
    }

    function i(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: G, messageId: n, mask: r, peerId: a}
    }

    function o(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: U, messageId: n, flags: r, peerId: a}
    }

    function s(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: q, messageId: n, flags: r, peerId: a}
    }

    function l(e) {
        var t = N(e, 11), n = t[1], r = t[2], a = t[3], i = t[4], o = t[5], s = t[6], l = t[7], u = t[8], c = t[9],
            d = t[10], g = extend(s, l || void 0);
    ...
    function c(e) {
        return extend({}, e, {type: fe})
    }

    function d(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: V, peerId: n, upToId: r, unread: a}
    }

    function g(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: W, peerId: n, upToId: r, unread: a}
    }

    function m(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: K, userId: -n, platform: r, lastSeenTs: a}
    }

    function f(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3];
        return {type: Y, userId: -n, reason: r, lastSeenTs: a}
    }

    function p(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3], i = void 0 === a ? !1 : a;
        return {type: ne, peerId: n, mask: r, local: i}
    }

    function _(e) {
        var t = N(e, 3), n = t[1], r = t[2];
        return {type: re, peerId: n, mask: r}
    }

    function h(e) {
        var t = N(e, 4), n = t[1], r = t[2], a = t[3], i = void 0 === a ? !1 : a;
        return {type: ae, peerId: n, mask: r, local: i}
    }

    function v(e) {
        var t = N(e, 3), n = t[1], r = t[2];
        return {type: me, peerId: n, localId: r}
    }

    function b(e) {
        var t = N(e, 3), n = t[1], r = t[2];
        return {type: Q, chatId: n, self: r}
    }

    function y(e) {
        var t = r(e), n = t[1], a = t[2], i = t.slice(3);
        return {type: X, peerId: 2e9 > n ? n + 2e9 : n, updateType: a, intVector: i}
    }

    function w(e) {
        var t = N(e, 2), n = t[1];
        return {type: $, userId: n, peerId: n}
    }

    function C(e) {
        var t = N(e, 3), n = t[1], r = t[2];
        return {type: $, userId: n, peerId: r + 2e9}
    }

    function E(e) {
        var t = N(e, 3), n = t[1], r = t[2];
        return {type: Z, userId: n, callId: r}
    }

    function k(e) {
        var t = N(e, 2), n = t[1];
        return {type: J, count: n}
    }

    function T(e) {
        var t = N(e, 2), n = t[1], r = void 0 === n ? {} : n;
        return {type: ee, peerId: r.peer_id, sound: r.sound, disabledUntil: r.disabled_until}
    }

    function S(e) {
        var t = N(e, 2), n = t[1], r = void 0 === n ? {} : n,
            a = l([!1, r.id, r.flags, r.peer_id, r.date, r.message, extend(r.kludges, {title: r.title || ""}), {}, r.random_id, r.chat_local_id, r.update_time]);
        return a.type = fe, a
    }

    function I(e) {
        return {type: te, params: e}
    }

    function A(e) {
        return {type: oe, state: e}
    }
    ...
    function L() {
        ...
        return {type: se, cancelSearch: e, removeActivePeer: t}
    }
    ...
    function P(e) {
        ...
        return {type: ue, peerId: e, msgid: t, forward: n, cancelSearch: r}
    }

    function O(e) {
        return {type: ce, tab: e}
    }

    function D(e, t, n) {
        return {type: de, message: t, peer: e, error: n}
    }

    function x(e) {
        var t = N(e, 6), n = (t[0], t[1]), r = t[2], a = t[3], i = t[4], o = t[5];
        return {
            type: le,
    ...
    var B = n(7), F = n(8), H = n(61), j = t.DELETE = "event_delete", U = t.SET_FLAGS = "event_set_flags",
        G = t.REPLACE_FLAGS = "event_replace_flags", q = t.RESET_FLAGS = "event_reset_flags",
        z = t.ADD_MESSAGE = "event_add_message", V = t.READ_INBOUND = "event_read_inbound",
        W = t.READ_OUTBOUND = "event_read_outbound", K = t.GOT_ONLINE = "event_got_online",
        Y = t.GOT_OFFLINE = "event_got_offline", Q = t.CHAT_CHANGED = "event_chat_changed",
        X = t.CONVERSATION_UPDATED = "event_chat_updated", $ = t.TYPING = "event_typing",
        Z = t.VIDEO_CALL = "event_video_call", J = t.UNREAD_COUNT = "event_unread_count",
        ee = t.NOTIFY_SETTINGS_CHANGED = "event_notify_settings_changed", te = t.EMPTY = "event_empty",
        ne = t.RESET_DIRECTORIES = "event_reset_directories", re = t.REPLACE_DIRECTORIES = "event_replace_directories",
        ae = t.SET_DIRECTORIES = "event_set_directories", ie = t.RESYNC = "event_resync",
        oe = t.TRANSITION = "transition_event", se = t.RESET_PEER = "reset_peer", le = t.MUTEX = "mutex",
        ue = t.CHANGE_PEER = "change_peer", ce = t.CHANGE_TAB = "event_change_tab",
        de = t.FAILED_MESSAGE = "event_failed_message", ge = t.RESEND = "event_resend",
        me = t.DELETE_DIALOG = "event_delete_dialog", fe = t.EDIT_MESSAGE = "event_edit_message";
    ...
    function s(e, t) {
        var n = r.bind(null, t), a = (0, l.createModule)({
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.doesSearchResultContainConversations = o, t.mount = s;
    var l = n(106), u = n(113), c = n(7), d = n(43)
}, , function (e, t, n) {
    var r = n(9)("wks"), a = n(56), i = n(159).Symbol, o = "function" == typeof i;
    e.exports = function (e) {
    ...
    function o(e, t, n, r) {
        var a = gpeByClass("_im_peer_tab", r), i = intval(domData(a, "list-id")),
            o = e.get().tabbedPeers.filter(function (e) {
                var t = e.peer;
                return t !== i
            });
        return e.set(_.updateTabbedPeers.bind(null, o, !0)).then(function () {
            if (s(t, e), i === e.get().peer) e.get().longpoll.push([(0, h.resetPeer)()]); else if (0 !== e.get().peer) {
    ...
    function u(e, t, n, r) {
        return {
            updateMenu: function (t) {
                ...
                if (n) {
                    var r = geByClass1("_im_r_tx", n), a = t.get().tabs[e].tab;
                    val(r, a)
                }
            }, updateCounter: function (e, t) {
                var n = ge("ui_rmenu_peer_" + t);
                if (n) {
                    var r = geByClass1("_im_r_ct", n), a = e.get().tabs[t].unread;
    ...
    function d(e, t, n) {
        var r = (0, g.mount)(e, (0, f["default"])({limit: 50, offset: 0, noScroll: !0, elements: a(t)}), function () {
            return {
                idFn: function (e) {
                    return e.peer || "000"
                }, renderFn: i.bind(null, t)
            }
        }), s = o.bind(null, t, r), l = (0, v.createModule)({
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = d;
    var g = n(24), m = n(66), f = r(m), p = n(7), _ = n(113), h = n(43), v = n(106), b = n(31)
}, function (e, t, n) {
    var r = n(131), a = Math.min;
    e.exports = function (e) {
    ...
    function s() {
        _.forEach(function (e, t) {
            var n = e.onData, r = e.onUpdateKey, a = e.ts;
            i(t) && Notifier.addKey(extend(t, {ts: a}), d.bind(null, n, r, t))
        })
    }
    ...
    function c(e, t, n, r) {
        ...
        (0, p.pause)(3).then(function () {
            ...
            _.set(e, {onUpdateKey: r, onData: n, ts: e.ts}), s(), l()
        })
    }
    ...
    function g(e, t, n) {
        return Notifier.addKey(e, d.bind(null, t, n, e)), _.set(e, {
            ...
            onUpdateKey: n,
            ts: e.ts
        }), l(), {stop: u.bind(null, e)}
    }

    Object.defineProperty(t, "__esModule", {value: !0}), t.createWorker = g;
    var m = n(114), f = r(m), p = n(63), _ = new f["default"], h = !1
}, function (e, t, n) {
    "use strict";
    ...
    function a(e, t, n) {
        var a = (0, i.createMutations)(r), o = a.bindMutations, s = (0, i.createModule)({
            handlers: function (e, t) {
            }
        });
        return o(s)
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = a;
    var i = n(106)
}, function (e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.MAIL_CHAT_FLAG_ADMINS_CAN_ADD_ADMINS = t.MAIL_CHAT_FLAG_ONLY_ADMINS_CAN_CHANGE_TITLE = t.MAIL_CHAT_FLAG_ONLY_ADMINS_CAN_PIN = t.MAIL_CHAT_FLAG_ONLY_ADMINS_CAN_KICK = t.MAIL_CHAT_FLAG_ONLY_ADMINS_CAN_INVITE = void 0;
    var m = function () {
        function e(e, t) {
            var n = [], r = !0, a = !1, i = void 0;
            try {
    ...
    var f = n(7), p = n(152), _ = n(113), h = n(104),
    ...
    var r = n(125), a = n(50), i = n(115);
    e.exports = function (e) {
        return function (t, n, o) {
            var s, l = r(t), u = a(l.length), c = i(o, u);
            if (e && n != n) {
                for (; u > c;) if (s = l[c++], s != s) return !0
            } else for (; u > c; c++) if ((e || c in l) && l[c] === n) return e || c;
            return !e && -1
        }
    }
}, function (e, t) {
    ...
    function r(e, t, n, r, a) {
        if ("Script error." !== e) {
            ...
            o("unhandled_error", i ? {err: e, stack: i} : {err: e})
        }
    ...
    function o(e, t) {
        i() && (console.error(e, t), console.trace(), (0, d.retryFn)(c.post, 3, function () {
            ...
            act: "a_weird_log",
            kind: e,
            data: JSON.stringify(extend({errIdx: m++, ua: navigator.userAgent, noSh: 1}, t))
        }))
    }

    function s(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        return o(e, extend({err: t && t.message || t}, n)), Promise.reject(t)
    }
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.isWeirdLogging = i, t.imWeirdLog = o, t.imWeirdCatch = s, t.startLoggingAllUnhandled = l, t.stopLoggingAllUnhandled = u;
    var c = n(33), d = n(63), g = void 0, m = 1
}, function (e, t, n) {
    var r = n(46)("iterator"), a = !1;
    try {
        var i = [7][r]();
        i["return"] = function () {
            a = !0
    ...
    function r(e, t) {
        var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, a = 0;
        return function i() {
    ...
    function i(e, t) {
        var n = void 0, r = new Promise(function (r) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.pause = n, t.retryFn = r, t.debouncedPromise = a, t.abortablePause = i
}, function (e, t) {
    e.exports = function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = debounce(r, 300),
            o = extend({}, e), s = [];
        return t.store && (o = ls.get(t.key) || o), {
            get: function () {
                return o
            }, set: function (e) {
                var r = this, s = (0, i.isWeirdLogging)() ? a(this.set) : null;
                return e(o).then(function (e) {
                    return o = e, t.store && n(t.key, e), r
                })["catch"](function (e) {
                    return (0, i.imWeirdCatch)("store_set_catch", e, {stack: s})
                })
            }, setState: function (e) {
    ...
    function a(e, t, n, a, o) {
        if (!(0, c.isSearchingInplace)(e.get().peer, e.get()) && !(hasClass(o, u.FAILED_CLASS) || hasClass(o, u.SENDING_CLASS) || hasClass(o, "_im_mess_srv") || (0, u.checkSelectClick)(a, o) || (0, d.isAnyMessageBeingEdited)(e) || "A" === a.target.tagName || a.target.classList.contains(g))) {
            var s = intval(domData(o, "msgid")), l = e.get().peer;
            if (!(0, u.isAlreadyDeleted)(e, l, s)) {
                ...
                m = a.shiftKey ? (0, d.getMessageRangeFromSelection)(e, l, s) : [s], e.set(c.addSelection.bind(null, m)).then(function () {
                    var a = (0, d.getSelectedMessages)(e), i = !1;
    ...
    function i(e) {
        ...
        if (t.pinnedMessagesPromo && (0, u.isChatPeer)(t.peer)) {
            var n = geByClass1("_mess-action-promo"), r = new ElementTooltip(n, {
                autoShow: !1,
                appendTo: n,
                content: getTemplate("im_pinned_messages_promo", {content: getLang("mail_pinned_messages_promo_tooltip")}),
                forceSide: "bottom",
                cls: "feature_intro_tt",
                width: 260,
                onHide: function () {
                    e.setState({pinnedMessagesPromo: !1}), (0, c.hidePromoTooltip)()
                }
            });
            return r.show(), r
        }
    ...
    function s(e, t, n) {
        var r = a.bind(null, t, n, e), i = (0, l.createModule)({
            handlers: function (t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = s;
    var l = n(106), u = n(7), c = n(113), d = n(152), g = "_im_retry_media"
}, , function (e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.screenfull = function () {
        var e = "undefined" != typeof Element && "ALLOW_KEYBOARD_INPUT" in Element, t = function () {
            for (var e, t, n = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], r = 0, a = n.length, i = {}; a > r; r++) if (e = n[r],
                e && e[1] in document) {
            ...
            i(e).then(function (e) {
                return e.file ? new Promise(function (n, r) {
                    ajax.post("/docs.php", extend({
                        ...
                        onDone: function (e, r) {
                            m(), W([["doc", e + "_" + r, "audiomsg"]], {}, t.peer), w(), n()
                        }, onFail: function (e) {
                            r(e)
                        }, progress: null
                    })
    ...
    function S(e, t, n) {
        return {
            cancelRecording: _, start: function () {
                c()
            }, unmount: function () {
                _(), E()
            }
    ...
    function I(e, t, n, r) {
        ...
        var a = (0, A.createMutations)(S), i = a.bindMutations;
        return i(e, t, n)
    }

    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = I;
    var A = n(106), M = n(113), L = n(38), P = n(7), O = 600,
        D = browser.msie && intval(browser.version) < 10 ? window.XDomainRequest : window.XMLHttpRequest, x = void 0,
        R = void 0, N = void 0, B = void 0, F = void 0, H = void 0, j = void 0, U = void 0, G = void 0, q = void 0,
        z = void 0, V = void 0, W = void 0, K = void 0, Y = !1, Q = !1, X = 100
}, function (e, t, n) {
    "use strict";
    ...
    function a(e, t) {
        showTooltip(t.target, {content: r("im_settings_pop"), dir: "down", shift: [220, 9], hasover: !0, showdt: 300})
    }
    ...
    function o(e, t, n, a, o) {
        var s = domData(o, "action"), l = gpeByClass("_im_settings_menu", o),
    ...
    function s(e, t) {
        return {
            updateFilter: function (t) {
                var n = void 0, r = t.get().active_tab === m.FOLDER_UNREAD;
    ...
    function l(e, t, n) {
        var r = a.bind(null, t), i = o.bind(null, t, n, e), l = function (e, r) {
            if ((0, g.showUnreadOnly)(t, n, d.changeDialogsTab)) {
                var a = t.get().active_tab === m.FOLDER_UNREAD;
                val(r, getTemplate("im_filter", {filter: a ? getLang("mail_to_all_dialogs") : getLang("mail_to_unread")}))
            }
        }, c = (0, u.createModule)({
            handlers: function (t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = l;
    var u = n(106), c = n(39), d = n(113), g = n(7), m = n(31), f = "_im_dialogs_cog_settings",
        p = "_im_settings_action", _ = "_im_to_unread"
}, , , function (e, t) {
    e.exports = function (e, t) {
    ...
    function r(e, t) {
        ...
        var n = (0, h.getTab)(e, t), r = n && (0, h.parserMessage)(n.pinned);
        return r ? n.pinHideId != r.chat_local_id : !1
    }

    function a(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, a = (0, h.getTab)(e, t),
    ...
    function o(e, t, n) {
        var r = l.bind(null, n, t), a = (0, _.showUnpinDialog)(function () {
    ...
    function s(e, t, n) {
        var r = e.get(), i = r.peer, o = (0, h.parserMessage)((0, h.getTab)(e, i).pinned);
        if (n.target.classList.contains(y)) o && a(e, i, t); else if ("A" !== n.target.tagName) {
            var s = o && o.messageId;
            if (s && !(0, _.isAlreadyDeleted)(e, i, s)) {
                var l = e.get(), u = (0, h.getMessage)(e, i, s);
                u ? (e.setState({msgid: s}), (0, v.updateLocation)({msgid: s}), t().focusOnMessage()) : l.longpoll.push([(0, f.changePeer)(i, s)])
    ...
    function d(e, t, n) {
        var r = (0, g.createMutations)(c), a = r.bindMutations, i = s.bind(null, t, n), o = u.bind(null),
            l = (0, g.createModule)({
                handlers: function (t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.isPinnedMessageVisibleInTab = r, t.pinnedMessageHide = a, t.pinnedMessageUnHide = i, t.pinnedMessageUnpin = o, t.mount = d;
    var g = n(106), m = n(113), f = n(43), p = n(53), _ = n(7), h = n(152), v = n(155), b = n(104), y = "_im_pin_hide",
        w = "_im_pinned_message"
}, function (e, t, n) {
    var r = n(163), a = n(86).set;
    e.exports = function (e, t, n) {
    ...
    function i(e, t) {
        domData(e, "ts") !== t.date && (e.innerHTML = t.text, domData(e, "ts", t.date), setStyle(e, {visibility: "visible"}))
    }

    function o(e, t, n, r) {
        var a = e instanceof Array ? e : geByClass("_im_bar_date", e), i = t.contHeight();
    ...
    function l(e, t, n, r, a) {
        var i = e.get().barMap[t], o = (0, h.isClassicInterface)(a) ? A : I;
        return n - (i[0] + n - i[1]) + r - o
    }

    function u(e, t) {
        var n = e.get().barMap[t][2];
        return {text: n.textContent, date: domData(n, "date")}
    }
    ...
    function g(e, t, n, r, a) {
        var i = e.get(), o = void 0, s = void 0, c = n - t;
        ...
        var d = {};
        return [[s, "prev"], [o, "cur"]].forEach(function (t) {
            var i = _(t, 2), o = i[0], s = i[1];
            o && (d[s + "Bar"] = u(e, o), d[s + "Left"] = l(e, o, n, r, a) - c)
        }), d
    }

    function m(e) {
        var t = geByClass1("_im_mess", e), n = domData(t, "ts");
        return t && n ? {text: getShortDate(intval(n), !1, !0, getLang("months_of", "raw")), date: n} : null
    }

    function f(e, t, n, r, o) {
        var s = e.get(), l = (0, v.isEverythingLoaded)(s), u = t.get(), f = o.scrollTop(),
            p = u.lastTop ? u.lastTop - f : 0;
        u.lastTop = f;
        var _ = (0, E.isPinnedMessageVisibleInTab)(s, s.peer) ? (0, h.getPinnedMessageHeight)() : 0,
            b = ((0, h.isClassicInterface)(e) ? k + _ : 0) - T / 2, y = o.contHeight(), w = g(t, f, y, b, e),
            C = w.prevBar, S = w.curBar, I = w.prevLeft, A = "translateY(0px)", M = !1, L = !1, P = !1;
    ...
    function p(e, t) {
        var n = geByClass1("_im_top_date_bar"), r = (0, C["default"])({lastTop: !1, barMap: {}, barMapKeys: []}),
            a = null, i = null, l = null, u = debounce(function (e) {
    ...
    var h = n(7), v = n(113), b = n(112), y = r(b), w = n(66), C = r(w), E = n(77), k = 68, T = 32, S = 300, I = 20,
        A = 68, M = 10, L = 2e3, P = 100
}, function (e, t, n) {
    var r = n(163), a = n(159).document, i = r(a) && r(a.createElement);
    e.exports = function (e) {
    ...
    var r = n(163), a = n(17), i = function (e, t) {
    ...
    function a(e, t) {
        var n = ge("page_header"), r = geByClass1("_im_chat_input_w", t), a = r.offsetHeight - r.clientHeight;
        return Math.min(window.clientHeight() - a, Math.max(Math.max(0, e), Pe + n.offsetHeight + t.offsetTop))
    }

    function i(e, t) {
        var n = intval(domData(t.target, "msgid")), r = gpeByClass("_im_mess_" + n, t.target),
            a = geByClass1("_im_log_body", r), i = geByClass1("_im_mess_susp_cont", r);
    ...
    function s(e, t, n) {
        var r = geByClass1(e, t), i = void 0, o = void 0;
    ...
    function d(e, t, n, r, a) {
        ...
        var i = q2ajx(a.getAttribute("href")), o = intval(i.msgid);
    ...
    function g(e, t, n) {
        var r = (0, re.getTab)(t, n), a = (0, te.strHistory)(r.history);
    ...
    function m(e, t, n, r) {
        if (hasClass(n.target, "_im_mess_marker")) {
            ...
            window.tooltips && (0, oe.toArray)(geByClass(ne.FAILED_CLASS, t)).map(function (e) {
                ...
                return tooltips.hide(e, {fasthide: !0})
            });
            var i = domData(r, "msgid");
            showTooltip(a, {
                content: getTemplate("im_failed_menu", {id: i}),
    ...
    function _(e, t) {
        var n = t.contHeight(), r = e.scrollTop + (n - e.contHeight);
        t.scrollTop(r)
    }

    function h(e, t, n, r, a, i, o) {
        var s = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : !0,
            l = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : !1, u = (t.get().tabs || {})[n];
        ...
        if ((0, te.isSearchingInplace)(n, t.get()) ? a().showSearch(t) : a().cancelSearch(t, !1), o.changePeer(n, t), t.get().msgid) k(r, e, t.get().msgid, t); else if (u.scrollBottom && s) {
            _(u, r);
            var m = (0, ne.isMessagesVisible)(t, e, r), f = ee(m, 1), p = f[0];
    ...
    function v(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1, r = n || t.scrollTop(),
            a = t.scrollBottom(), i = t.contHeight(), o = e.get().peer;
    ...
    function y(e, t, n) {
        var r = (0, re.isGoToEndVisible)(e), a = 4 * t.getScrollHeight();
    ...
    function w(e, t, n, r, a, i, o, s) {
        ...
        if ((e.get().history_init || (e.get().history_init = !0, !(s.scrollTop() >= 0))) && !b()) {
            ...
            if (0 !== u && (0, ne.isFullyLoadedTab)(e.get(), u) && (Ce["default"].onHistoryScroll(s.scrollTop()), !layers.visible)) {
                var c = (0, re.isGoToEndVisible)(e), d = (0, re.getTab)(e, u);
                ...
                if (!(0, te.isSearchingInplace)(u, e.get()) && l && r(s), !Qe && (0 > o || 0 === s.scrollBottom()) && s.scrollBottom() < Ie) {
                    ...
                    if (d.skipped > 0 && !e.get().no_moving_down) {
                        var m = gpeByClass("_im_page_history", m), f = e.get();
                        Qe = !0;
                        var p = e.set(te.loadLessHistory).then(t().loadHistory.bind(null, f.peer, {reversed: !0})).then(function () {
    ...
    function E(e, t, n, r, a) {
        ...
        if (i) {
            var o = r.get(), s = o.peer, l = i.getBoundingClientRect(),
            ...
            return e.scrollTop(d), v(r, e, d), setTimeout(function () {
                s === r.get().peer && w(r, n, f(t), function () {
                }, a, t, 0, e)
            }, 80), C(r), !0
        }
        return !1
    ...
    function k(e, t, n, r) {
        var a = o(t, n);
        if (a) {
            var i = (0, ne.isClassicInterface)(r), s = r.get().peer,
    ...
    function S(e, t, n, r, a) {
        var i = domData(a, "action"), s = domData(a, "msgid"), l = geByClass1("_im_mess_marker", o(n, s));
        switch (i) {
            case"resend":
                t(r, a);
                break;
    ...
    function A(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, a = e.get().peer;
        if (!(0, ne.isReservedPeer)(a)) {
            var i = e.get().tabs[a], o = geByClass1(Re, t), s = geByClass1("_im_to_end_label", o);
    ...
    function L(e, t, n, r, a) {
        var i = domData(a, "msgid"), o = e.get().peer, s = (0, re.getMessage)(e, o, i);
    ...
    function P(e, t, n, r, a) {
        var i = intval(domData(a, "peer")), o = intval(domData(gpeByClass("_im_mess", a), "msgid")),
            s = e.get().tabs[i].hash;
    ...
    function N(e, t, n) {
        ...
        if ((0, ne.isClassicInterface)(e)) {
            var i = t.contHeight(), o = geByClass1("_im_chat_input_w", n), s = o.offsetHeight - o.clientHeight,
                l = geByClass1("_im_chat_resize", n), u = geByClass1("_im_chat_input_parent", n),
                c = geByClass1("_im_chat_audio_input_parent", n);
            if (r = r !== !1 ? r : (0, ne.getClassicChatHeight)(), r !== !1 && r > 0) {
                var d = a(r, n), g = hasClass(c, ze) || hasClass(c, qe), m = g ? c : u, f = d - m.offsetHeight;
                l.style.height = window.clientHeight() - d - s + "px", setStyle(o, {top: f + "px", bottom: "auto"})
            } else l.style.height = "0px", setStyle(o, {top: "auto", bottom: "0px"});
            var p = geByClass1("_im_peer_history_w", n);
            return setStyle(p, {borderBottomWidth: o.offsetHeight - Oe - 1}), t.contHeight() - i
        }
    ...
    function j(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1, r = geByClass1(Re, t);
    ...
    function G(e, t) {
        var n = e.get(), r = n.peer, a = domClosest(Ve, t.target), i = intval(domData(a, "msgid")),
            o = (0, re.getMessage)(e, r, i), s = o && (0, ne.isServiceMsg)(o) && o.kludges.source_act;
        if (s === ne.CHAT_PIN_MESSAGE || s === ne.CHAT_UNPIN_MESSAGE) {
            ...
            if (l && "A" !== l.tagName) {
                ...
                Xe[u] = (0, te.getMessageLocalId)(r, u, n).then(function (e) {
                    var t = ee(e, 1), n = t[0];
                    if (n) {
                        var a = "/im?sel=" + (0, ne.convertPeerToUrl)(r) + "&msgid=" + n, i = l.innerHTML;
    ...
    function q(e, t, n) {
        var r = e.get(), a = r.peer, i = n.target.href && n.target.href.match(/msgid=([\d]+)/), o = i && i[1];
        if ("A" === n.target.tagName && o && !(0, ne.isAlreadyDeleted)(e, a, o) && !checkEvent(n)) {
            var s = (0, re.getMessage)(e, a, o);
            s ? (e.setState({msgid: o}), (0, Ee.updateLocation)({msgid: o}), t().focusOnMessage()) : r.longpoll.push([(0, be.changePeer)(a, o)])
        }
        cancelEvent(n)
    }
    ...
    function V(e, t, n, r, a) {
        e.setState({isEditing: !0}), n.saveText(e), addClass(r, "im-mess_is_editing"), addClass(geByClass1("_im_page_history"), "is_msg_editing"), cancelStackPush("cancel_edit", function () {
            return W(e, t, n, r, a)
        });
    ...
    function W(e, t, n, r, a) {
        e.setState({isEditing: !1}), removeClass(r, "im-mess_is_editing"), removeClass(geByClass1("_im_page_history"), "is_msg_editing"), cancelStackFilter("cancel_edit"), n.setDraft(e, (0, re.getPeer)(e) ? (0, re.getTabDraft)((0, re.getCurrentTab)(e)) : null), n.toggleStickers(e, !0), Y(t)
    }

    function K(e) {
        var t = geByClass1("im-mess_is_editing");
        if (!t) return null;
        var n = e.get().tabs[e.get().peer], r = (0, re.parserMessage)(n.msgs[domData(t, "msgid")]);
    ...
    function Q(e, t, n) {
        var r = e.get(), a = domClosest(Ye, n.target), i = domData(a, "msgid"), o = (0, re.getMessage)(r, r.peer, i),
            s = function (e) {
    ...
    function X(e, t) {
        (0, ne.boxHandleEditTimeTooltips)(showBox("al_im.php", t, {dark: 1}), e)
    }

    function $(e, t, n, r, a) {
        var i = 50, o = (0, re.getTab)(e, t),
    ...
    function Z(e, t, n, r, a, i, s, u, d, g, m, b, y, w, C) {
        var E = void 0, S = throttle(function () {
        ...
        return {
            changePeer: function (e) {
                ...
                if ((0, ne.isFullyLoadedTab)(e.get(), e.get().peer)) {
                    ...
                    var l = e.get().peer, d = e.get().prevPeer;
                ...
                var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1, o = a.get();
                if ((0, ne.isPeerActive)(e, o)) {
                    var s = i || o.tabs[e].historyToAppend;
                    if (!s) return;
                    var l = geByClass1("_im_peer_history", t), u = domFC(l), c = n.scrollBottom(),
                    ...
                    var m = sech(s), f = document.createDocumentFragment();
                    m.forEach(function (e) {
                ...
                if (!(0, te.isSearchingInplace)(r.peerId, e.get()) && (0, ne.isFullyLoadedTab)(e, r.peerId) && (0, ne.isPeerActive)(r.peerId, e.get())) {
                    ...
                    var a = f(t);
                    B(C, a, n, function () {
                        var o = M(n), s = geByClass1("_im_unread_bar_row", t), l = (0, ne.isMessagesVisible)(e, t, n),
                            u = ee(l, 2), c = u[0], d = u[1];
                        (0, ne.appendToHistory)(e.get(), r, a, !0, !0, !c && !s), removeClass(t, "im-page--history_empty-hist");
                        var g = (0, re.getTab)(e, e.get().peer), m = (0, ne.isServiceMsg)(r) && r.userId === vk.id,
                    ...
                    if (n.get().peer === e && (0, ne.isFullyLoadedTab)(r, e)) {
                        ...
                        if (o || a) {
                            if (!o) {
                                ...
                                val(s, getTemplate("im_typing", {cls: (0, ne.isClassicInterface)(n) ? "im-typing_classic" : ""})), o = geByClass1(ne.TYPING_CLASS, t)
                            }
                ...
                if ((0, ne.isPeerActive)(a.peerId, e.get())) B(C, f(t), n, function () {
                    ...
                    i && n.scrollBottom(0)
                }), C.update(n); else if ((0, ae.isMoneyRequest)(a)) {
                ...
                addClass(t, "im-page--hisory_search-open"), e.setState({searchShown: !0}), (0, re.getPinnedMessage)(e) && this.updateChatTopic(e.get().peer, e), this.cancelEditing(), setTimeout(function () {
                    return u.focus(e)
                }, 10)
            }, cancelSearch: function (e) {
                var a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : !0;
                if (e.get().searchShown && (removeClass(t, "im-page--hisory_search-open"), removeClass(t, "im-page--history_search"), removeClass(t, "im-page--history_search-empty"), e.setState({searchShown: !1}), (0, re.getPinnedMessage)(e) && this.updateChatTopic(e.get().peer, e), r.changedMessageSelection(e)), a && !(0, ne.isReservedPeer)(e.get().peer) && E) {
    ...
    function J(e, t, n) {
        ...
        var a = (0, se.createMutations)(Z), o = a.callMutations, l = a.bindMutations, c = function (e) {
                var t = debounce(e, 100), n = throttle(e, 100);
                return function (e) {
                    t(e), n(e)
                }
            }(v.bind(null, t)), p = (0, ve.mount)(t, e), _ = w.bind(null, t, o, r, c, p, e),
        ...
        var b = (0, le.mount)(geByClass1("_im_dialog_actions", e), t, o),
            ...
            C = (0, de.mount)(geByClass1("_im_dialog_actions", e), t, o), I = (0, fe.mount)(e, t, o),
            M = (0, pe.mount)(e, t, function () {
                return {changedMessageSelection: b.changedMessageSelection}
            });
        ...
        var x = L.bind(null, t, e, o), N = P.bind(null, t, e, h), B = D.bind(null, t, n, e), H = O.bind(null, n, t),
            j = R.bind(null, o, t, e, h), V = m.bind(null, t, e), W = ne.showEditTimeTooltip.bind(null, t),
            K = S.bind(null, t, x, e), Y = ne.showChatMembers.bind(null, t, o, te.setCreationType),
            $ = d.bind(null, t, e, h), J = U.bind(null, o, t, h), ee = G.bind(null, t), ae = q.bind(null, t, o),
                ...
                handlers: function (n, r) {
                    r(e, "click", ne.RESTORE_CLASS, N), r(e, "mouseover click", ne.FAILED_CLASS, V), r(e, "mouseover", "_im_edit_time", W), r(e, "click", "_im_mess_susp", i.bind(null, e)), r(e, "click", xe, B), r(e, "click", Ne, K), r(e, "click", ne.SHOW_CHAT_MEMBERS_CLASS, Y), r(e, "click", Be, $), r(e, "mouseover", Fe, F), r(e, "mouseover", Ve, ee), r(e, "click", We, ae), r(e, "click", je, u), r(e, "click", Ke, function (e, n) {
                        ...
                        var r = geByClass1("flat_button", n),
                            a = {invite_chat_id: domData(r, "inv-id"), invite_hash: domData(r, "hash")};
    ...
    t.mount = J;
    var te = n(113), ne = n(7), re = n(152), ae = n(92), ie = n(69), oe = n(30), se = n(106), le = n(134), ue = n(22),
        de = n(12), me = n(44), fe = n(143), pe = n(67), _e = n(77), he = n(151), ve = n(81), be = n(43), ye = n(15),
        we = n(112), Ce = r(we), Ee = n(155), ke = n(104), Te = n(132), Se = n(8), Ie = 1e3, Ae = -30, Me = 30,
        Le = 2e3, Pe = 700, Oe = 15, De = 47, xe = "_im_cancel_fwd", Re = "_im_to_end", Ne = "_im_failed_action",
        Be = "_im_mess_link", Fe = "_im_admin_name", He = "_im_typer_c", je = "_im_error", Ue = "_im_join_cancel",
        Ge = "_im_retry_media", qe = "im-audio-message_recorded", ze = "im-audio-message_recording",
        Ve = "_im_mess_srv", We = "im_srv_mess_link", Ke = "_chat_invitation", Ye = "_im_mess", Qe = !1, Xe = {}
}, function (e, t, n) {
    "use strict";
    ...
    function i(e, t, n, r, a) {
        ...
        Object.keys(i).forEach(function (a) {
            ...
            e.set(oe.removeMessages.bind(null, o, a)).then(function () {
                ...
                var i = (0, ie.getTab)(e, a), s = i && o.some(function (e) {
                    return e >= i.lastmsg
                });
    ...
    function l(e, t) {
        if (e.get().gid) {
            var n = t.parentNode, r = geByClass("_im_right_menu_counter", n), a = e.get().dialog_tab_cts;
    ...
    function g(e, t) {
        var n = t.flags & Z.FLAG_OUTBOUND, r = inArray(t.peerId, e.get().mutedPeers), a = t.flags & Z.FLAG_DELETED,
            i = e.get().gid;
        if (!n && !r && !a) {
            var o = d(t.subject, t.peerId) || "", s = (o ? o + " " : "") + t.text || "", l = t.userId, u = t.peerId,
                c = void 0, g = void 0, m = e.get().tabs[u];
            if (t.kludges && t.kludges.source_act && (s = stripHTML((0, se.renderServiceMsg)(e, t, m, !1))), (!e.get().notify_msg && !(0, se.isChatPeer)(u) || i && !e.get().mute) && window.Notifier && Notifier.playSound({author_id: u}), !(0, se.isChatPeer)(u)) return;
            ...
            var f = t.attaches[0];
            if (f && "mail" === f.type) s += "\n[" + getLang("mail_added_msgs") + "]"; else if (f) {
    ...
    function m(e, t) {
        var n = e.get().longpoll.push.bind(null, [Z.resetPeer()]), r = function a() {
            var r = e.get().selectedMessages;
            r && r.length ? (e.setState({selectedMessages: []}).then(function () {
    ...
    function p(e, t) {
        var n = e.get().tabs[t.peerId], r = e.get().active_tab;
    ...
    function b(e, t) {
        var n = document.querySelector(ke), r = (0, se.isCommunityInterface)(e) ? we : Ce, a = n ? n.offsetHeight : 0;
    ...
    function C(e, t, n, r, a, i, o, s, l) {
        ...
        var c = e.set(oe.changePeer.bind(null, t.peerId, t.msgid)).then(function (e) {
            var n = e.get(), r = oe.loadPeer.bind(null, t.peerId, !1, t.msgid, !1, n);
    ...
    function T(e, t, n, r, a, i, o) {
        (0, se.isClassicInterface)(e) && (a.saveScroll(e), i.saveScroll(e)), r.rotateCross(e), addClass(o, "im-page_creating"), e.setState({isCreating: !0}), n && n.show(e, t), (0, se.isClassicInterface)(e) && (setStyle(o, {height: P(o, e).page}), setTimeout(function () {
    ...
    function M(e, t, n, r, i, o, d, m, v, b, w, M, L, P, O, D, x, R, N, F) {
        return {
            changePeer: function (e, n) {
                ...
                r.createCanceled(e, a), (0, se.isClassicInterface)(e) ? (setStyle(i, {height: "auto"}), removeClass(i, "im-page_cropped"), setTimeout(function () {
                ...
                }, 0), removeClass(i, "im-page_creating"), e.setState({isCreating: !1})
                ...
                return e.invite_chat_id && o.invite_hash ? !0 : (l && l.params && "left_nav" === l.params._ref && "undefined" == typeof e.sel && t.scrollUp(!0, !0), Object.keys(e).sort().forEach(function (e) {
                    switch (e) {
                        case"sel":
                            o.q || (u = !0);
                            var c = o.sel ? (0, se.unUrlPeer)(o.sel) : 0, d = l.back;
                ...
                })), f = o.filter(se.isServiceMsg), h = o.filter(function (e) {
                ...
                c(f, e, t, n, D), e.set(oe.checkNewPeople.bind(null, f, h, d)).then(function () {
                    s.forEach(function (o) {
                        switch (o.type) {
                            case Z.ADD_MESSAGE:
                                var s = e.get().tabs[e.get().peer], c = !s || !s.msgs || 0 == s.msgs.length,
                                    d = (0, se.isDuplicate)(o, e.get()), f = (0, ie.isCommunityBlocked)(e, o.peerId);
                                if (0 === d) {
                            ...
                            case Z.RESET_PEER:
                                if (o.removeActivePeer) {
                                    var S = e.get().tabbedPeers.filter(function (t) {
                                        var n = t.peer, r = t.type;
                                        return n !== e.get().peer && "perm" === r
                                    });
                                    e.setState({tabbedPeers: S})
                                }
                            ...
                            case Z.CHANGE_PEER:
                                ...
                                break;
                            case Z.MUTEX:
                                var I = a({}, o.peerId, o), A = (0, se.isPeerBlocked)(o.peerId, e);
    ...
    function P(e, t) {
        var n = ge("page_header"), r = geByClass1("_im_page_history", e),
            a = window.clientHeight() - n.offsetHeight - pe - 2, i = (0, se.isClassicInterface)(t) ? he : _e,
            o = {page: Math.max(a, i)};
    ...
    function O(e, t, n, r, a) {
        ...
        if (!isFullScreen()) {
            var s = P(e, t);
            if (setStyle(e, {minHeight: s.page}), (0, se.isClassicInterface)(t) && ("undefined" == typeof t.get().chatResizeInitialized && t.set(oe.initializeChatResize), setStyle(e, {height: t.get().isCreating ? s.page : "auto"}), setStyle(geByClass1("_im_page_dialogs", e), {
                    minHeight: s.page,
                    position: "static",
                    top: 0
    ...
    function R(e, t, n, r) {
        function i() {
            var t = (0, W.getNativeOption)("scrollLeft"), n = hasClass(e, "im-page--header_static"), r = [];
        ...
        var o = geByClass1("_im_chat_input_w", r), s = geByClass1("_im_dialog_actions", r), l = [t, n, o, s], u = null,
            c = hasClass(e, "im-page--header_static"), d = ge("im-group-online-disabled-notice");
        return d && l.push(d), l = l.concat(geByClass("_im_aside_notice"), geByClass("_im_aside_promo_block")), addEvent(window, "scroll", i), i(), function () {
    ...
    function F(e, t) {
        var n = t.get(), r = void 0, a = window.devicePixelRatio >= 2 ? "_2x" : "";
        setFavIcon("/images/icons/favicons/fav_im" + a + ".ico"), O(e, t, !1, !1, !1, !0), show(e);
        var o = (0, Y.createMutations)(M), l = o.callMutations, u = o.bindMutations, c = (0, X.startLongPoll)(n);
        c.on("data", function () {
            for (var e = arguments.length, n = Array(e), r = 0; e > r; r++) n[r] = arguments[r];
            return l().onEvents(t, n)
        });
        var d = geByClass1("_im_dialogs_search", e), g = geByClass1("_im_dialogs_settings", e),
            f = (0, j.mount)(geByClass1("_im_page_dcontent", e), t, l),
            p = (0, U.mount)(geByClass1("_im_page_history", e), t, l), _ = (0, G.mount)(d, t, l),
            h = (0, q.mount)(g, t, l), v = (0, ne.mount)(t);
        ...
        var C = n.isCreating, E = C ? "create" : 0 === n.peer ? "search" : "default";
        C && r.show(t, []);
        var k = (0, Q.create)(t, E, f, p, _, r), T = (0, ce.mount)(t, k);
        p.updateScroll();
        ...
        }), A = debounce(x, 300), P = O.bind(null, e, t, p, f, r, !1, A);
        t.setState({longpoll: c}), t.set(oe.setExecStack.bind(null, [])), I.on("unidle", function () {
            c.abortPauses(), S()
        }), I.start(), nav.objLoc.box && (s(t, nav.objLoc.box), (0, V.updateLocation)({box: null}));
        var D = N(t), B = void 0;
        ...
        var F = (0, ae.throttleAccumulate)(i.bind(null, t, p, f, b), 200), H = se.hideTopNotice.bind(null, t),
            W = se.hideAsideNotice.bind(null, t), K = (0, Y.createModule)({
                handlers: function (t, n) {
    ...
    t.mount = F;
    var j = n(101), U = n(88), G = n(124), q = n(72), z = n(141), V = n(155), W = n(151), K = n(118), Y = n(106),
        Q = n(105), X = n(11), $ = n(43), Z = r($), J = n(52), ee = n(39), te = n(49), ne = n(100), re = n(104),
        ae = n(30), ie = n(152), oe = n(113), se = n(7), le = n(31), ue = n(36), ce = n(6), de = n(121), me = n(61),
        fe = n(54), pe = 30, _e = 400, he = 250, ve = 32, be = 12, ye = 52, we = 5 * ve + 2 * be + ye,
        Ce = 3 * ve + 2 * be, Ee = 10, ke = "._im_aside_notice"
}, function (e, t, n) {
    var r = n(91);
    e.exports = function (e) {
        return Object(r(e))
    ...
    function o(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, r = e.attaches[0];
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.isUnread = a, t.isOut = i, t.isGraffiti = s, t.isAudioMsg = l, t.isSticker = u, t.isGift = c, t.isMoney = d, t.isMoneyRequest = g, t.isMessageWithInviteLink = m, t.isImportant = p, t.getUserId = _, t.wasEdited = h, t.isMessageSelected = v;
    var b = n(43), y = r(b)
}, function (e, t, n) {
    var r;
    (function (e, a, i) {
        (function () {
            ...
            function g() {
                var e = 0, t = new ee(p), n = document.createTextNode("");
            ...
            function h(e, t) {
                ...
                var a = new this.constructor(b), i = n._result;
                if (r) {
                    var o = arguments[r - 1];
                    $(function () {
                        R(r, a, o, i)
            ...
            function P(e, t, n, r) {
                var a = e._subscribers, i = a.length;
            ...
            var W, K, Y, Q = V, X = 0, $ = function (e, t) {
                    re[X] = e, re[X + 1] = t, X += 2, 2 === X && (K ? K(p) : Y())
                }, Z = "undefined" != typeof window ? window : void 0, J = Z || {},
            ...
            var ae = h, ie = v, oe = void 0, se = 1, le = 2, ue = new D, ce = new D, de = B, ge = F, me = H, fe = 0,
                pe = G;
            ...
            q.prototype._validationError = function () {
                ...
                if (r === ie) {
                    var a = C(e);
                    if (a === ae && e._state !== oe) this._settledAt(e._state, t, e._result); else if ("function" != typeof a) this._remaining--, this._result[t] = e; else if (n === pe) {
                        var i = new n(b);
            ...
            var he = z, ve = {Promise: pe, polyfill: he};
    ...
    function s(e) {
        ...
        return function () {
            ...
            setStyle(e, {width: 1});
            var r = e.offsetLeft;
            return t === r ? void setStyle(e, {width: n}) : (t = r, n = e.parentNode.offsetWidth, void setStyle(e, {width: Math.max(30, n - r - 20)}))
        }
    }
    ...
    function c(e, t, n, r) {
        var a = n.get().selection, i = uiSearch.getFieldEl(e);
    ...
    function g(e, t, n) {
        uiSearch.init(e, {onChange: l.bind(null, t, n)});
        var g = uiSearch.getFieldEl(e), m = ce("div", {className: "_ui_multiselection ui_multiselect_cnt"});
        g && g.parentNode.insertBefore(m, g);
        var _ = s(g);
        t.set(a);
        var h = o.bind(null, e, t, n, m, _), v = function (t) {
        ...
        return {
            addSelection: function (n, a) {
                return t.set(r.bind(null, {id: n, name: a})).then(c.bind(null, e, m, t, _))
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = g;
    var m = n(113), f = n(106), p = "_ui_multiselect_cancel"
}, , function (e, t, n) {
    var r = n(26), a = n(70), i = n(139), o = n(17), s = n(50), l = n(136);
    e.exports = function (e, t, n, u, c) {
        var d, g, m, f = c ? function () {
            return e
        } : l(e), p = r(n, u, t ? 2 : 1), _ = 0;
        if ("function" != typeof f) throw TypeError(e + " is not iterable!");
        if (i(f)) for (d = s(e.length); d > _; _++) t ? p(o(g = e[_])[0], g[1]) : p(e[_]); else for (m = f.call(e); !(g = m.next()).done;) a(m, p, g.value, t)
    }
}, , function (e, t, n) {
    var r = n(129), a = n(125), i = n(58)(!1), o = n(87)("IE_PROTO");
    e.exports = function (e, t) {
        var n, s = a(e), l = 0, u = [];
    ...
    function r(e) {
        var t = e.get().tabs, n = e.get().peer, r = Object.keys(t).filter(function (t) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = a;
    var i = n(7), o = n(113), s = 5e3, l = 54e6, u = 72e5
}, function (e, t, n) {
    "use strict";
    ...
    function i(e, t, n) {
        ...
        n.toTop(), n.reset(), (0, ae.statlogsProbValueEvent)(.01, "im_search_stat", 1, "search_messages_only"), r.length > 0 ? (r = [{type: "sep_messages"}].concat(r), e.setState({searchOnlyMessages: !0})) : r = [M()], n.pipeReplace(Promise.resolve(r))
    }
    ...
    function s(e, t, n, r) {
        ...
        var a = e.get().active_tab, i = e.get().dialog_tabs_all;
        return i[X.FOLDER_ALL] && !(0, K.isReversedDialogs)(e) || i[a] ? 0 === G(e).length ? Promise.resolve([{type: "empty_dialogs"}]) : Promise.resolve([]) : e.set(W.loadDialogs).then(function (t) {
            var n = G(e);
            return 0 === n.length ? [{type: "empty_dialogs"}] : n
        })
    }

    function l(e, t, n, r, a) {
        if (!gpeByClass("_im_peer_target", r.target)) {
            var i = t.get(), s = o(a), l = parseInt(domData(a, "peer"), 10), u = parseInt(domData(a, "msgid"), 10),
                c = (0, Y.getTab)(t, l);
            if (checkEvent(r)) return window.open(h(t, c, u, s));
            if (n.saveScroll("list"), s && i.msgid !== u) i.longpoll.push([te.changePeer(l, u)]); else if (l !== i.peer) {
    ...
    function d(e, t, n) {
        return n ? getTemplate("im_img_prebody", {photo: t}) : e + ":"
    }
    ...
    function p(e) {
        var t = w(e), n = e.unread > 0 ? e.unread : "";
        return n > 0 && t
    }
    ...
    function _(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1,
            ...
            a = u(e, t.peerId, t, (0, K.isClassicInterface)(e)), i = a.photo, o = a.userLink, s = n || w(t);
        if (!s) return m(t, i, o, e, r);
        var l = s.flags, c = y(t, e, n), d = [];
        ...
        var g = e.get().timeshift, _ = f(e, t, l) ? "nim-dialog_unread-out" : "",
    ...
    function h(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1, a = (0, K.getBaseLink)(e),
            i = function () {
    ...
    function v(e, t, n, r, a) {
        if (!t.deletedDialog) {
            ...
            var i = w(t), o = i.flags, s = y(t, n), l = u(n, t.peerId, t, (0, K.isClassicInterface)(n)), c = l.photo,
                d = n.get().timeshift,
    ...
    function b(e, t, n) {
        ...
        var r = u(n, t.peerId, t, (0, K.isClassicInterface)(n)), a = r.photo, i = geByClass1("_im_dialog_photo", e);
        i.innerHTML !== a && val(i, a), toggleOnline(geByClass1("_im_peer_online", e), t.online), p(t) && addClass(e, "nim-dialog_unread")
    }

    function y(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1, r = n || w(e);
        if ((0, K.isPeerBlocked)(e.peerId, t)) {
            ...
            return getTemplate("im_drow_prebody", {prebody: i, body: ""})
        }
    ...
    function T(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
            r = u(e, t.peerId, t, (0, K.isClassicInterface)(e)), a = r.photo, i = r.userLink, o = c(e),
            s = "" === n ? [] : [n];
    ...
    function S(e, t) {
        switch (t.type) {
            ...
            case"empty_dialogs":
                return getTemplate("im_dialogs_none", {msg: getLang("mail_dialogs_list_empty")});
            case"empty":
                return getTemplate("im_dialogs_none", {msg: getLang("mail_im_search_empty")});
            default:
    ...
    function I(e, t, n, r, a, i) {
        var o = intval(domData(i, "peer")), s = domData(i, "action"), l = domData(i, "sid"),
            u = geByClass1("_im_dialog_" + o, t), c = intval(domData(i, "spam"));
        switch (s) {
            case"restore":
    ...
    function A(e, t) {
        return e.map(function (e) {
            ...
            return extend({}, t[e.peerId], {message: e})
        })
    }

    function M(e) {
        return {type: "empty", lang: e}
    }
    ...
    function O(e, t, n, r) {
        var a = gpeByClass("_im_dialog", r, t), i = intval(domData(a, "peer"));
    ...
    function N(e, t, n, r, a) {
        var i = gpeByClass("_im_dialog", a, t), o = intval(domData(i, "peer")), s = e.get().tabs[o].lastmsg;
        ...
        }), showDoneBox(getLang("mail_marked_as_answered"), {out: 1e3}), cancelEvent(r), !1
    }

    function B(e) {
        var t = 42, n = 60, r = 45, a = 37, i = (0, Y.isSearching)(e), o = e.get().searchOnlyMessages;
        return (0, K.isClassicInterface)(e) ? {
            top: i && !o ? n + a - 1 : n,
            bottom: (0, K.isCommunityInterface)(e) ? t : t + r
        } : {top: i && !o ? a - 1 : 0, bottom: 0}
    }
    ...
    function j(e, t, n) {
        if ((0, Y.doPopularSuggExist)(e)) {
            var r = [{type: "sep_popular"}, {type: "popular_sugg"}];
        ...
        return {
            selectPeer: function (t, n) {
                for (var r = geByClass("_im_dialog", e), a = n.get().peer, i = 0; i < r.length; i++) {
                    var s = r[i], l = intval(domData(s, "peer")), u = intval(domData(s, "msgid"));
                ...
                removeClass(e.parentNode, "im-page--dialogs_with-mess"), n.saveScroll("list"), a ? (n.reset(), (0, K.isPendingForward)(t) || (0, Y.isRecentSearchesActive)(t) || !(0, Q.doesSearchResultContainConversations)(r) ? (0, Y.isRecentSearchesActive)(t) && ((0, Q.doesSearchResultContainConversations)(r) && (r = [{type: "clear_recent"}].concat(r)), (0, Y.doPopularSuggExist)(t) && (r = [{type: "sep_popular"}, {type: "popular_sugg"}].concat(r))) : r = [{type: "sep_btn_search_msg"}, {type: "sep_conversations"}].concat(r), t.setState({searchOnlyMessages: !1}), n.pipeReplace(Promise.resolve(r)).then(function () {
                    return F(n, t)
            ...
            }, unhoverDialogs: H.bind(n), selectHoveredDialog: function (t) {
                var a = geByClass1("_im_dialog_hovered", e);
                a || (a = geByClass1("_im_dialog", e)), a && l(r, t, n, {}, a)
            }, appendSearch: function (t, r, a) {
                var i = A(a, r);
                a.length > 0 ? (addClass(e.parentNode, "im-page--dialogs_with-mess"), n.pipe(Promise.resolve([{type: "sep_messages"}].concat(i))).then(function () {
                    return F(n, t)
                ...
                removeClass(e.parentNode, "im-page--dialogs_with-mess"), t.setState({searchOnlyMessages: !1}), 0 !== G(t).length || n.isLoading() || (a = !0), a && n.reset(), i && n.wipe(), n.pipeReplace(Promise.resolve(G(t))).then(function (e) {
                ...
                removeClass(e.parentNode, "im-page--dialogs_with-mess"), r.forEach(function (n) {
                    ...
                    r && b(r, n, t)
                }), (0, K.isPendingForward)(t) || (0, Y.isRecentSearchesActive)(t) || !(0, Q.doesSearchResultContainConversations)(r) || (r = [{type: "sep_btn_search_msg"}, {type: "sep_conversations"}].concat(r)), t.setState({searchOnlyMessages: !1}), n.isEmpty() && 0 === r.length && (0, K.isPendingForward)(t) && (r = [M(getLang("mail_im_search_empty_chats"))]), n.replacePreserveOrder(r)
            }, updateCounter: function (t, n) {
                var r = geByClass1("_im_dialog_" + n, e), a = (0, Y.getTab)(t, n);
                ...
                if (r) {
                    var a = n.get().tabs[t], i = geByClass1("_im_peer_online", r);
                ...
                var r = t.get().peer.toString(), a = "._im_dialog_" + r + "." + ue.join("."), i = domQuery(a, e)[0];
                ...
                if (r && !o(r) && !n.get().tabs[t].deletedDialog) {
                    var a = geByClass1("_im_dialog_typing", r), i = !(0, K.isClassicInterface)(n),
    ...
    function G(e) {
        var t = e.get().active_tab, n = e.get().dialog_tabs[t], r = e.get().tabs;
    ...
    function z(e, t, n) {
        var r = (0, ne.createMutations)(U), a = r.callMutations, o = r.bindMutations, u = function (e, n) {
            ...
            }, d = x.bind(null, t, e), g = O.bind(null, t, e), m = N.bind(null, t, e, a),
            f = geByClass1("_im_dialogs_search"), p = {
                idFn: function (e) {
                    return q(t, e)
                },
                ...
                return p
            }), h = l.bind(null, n, t, _), v = i.bind(null, t, e, _), b = I.bind(null, t, e, a, n),
            y = k.bind(null, n, t, e, _), w = (0, ne.createModule)({
                handlers: function (r, a) {
    ...
    t.mount = z;
    var W = n(113), K = n(7), Y = n(152), Q = n(44), X = n(31), $ = n(66), Z = a($), J = n(24), ee = n(43), te = r(ee),
        ne = n(106), ae = n(137), ie = n(121), oe = 64, se = "_im_dialog_star", le = "_im_dialog_daction",
        ue = ["_im_dialog_selected", "nim-dialog_selected"], ce = ["_im_dialog_hovered", "nim-dialog_hovered"]
}, , function (e, t, n) {
    ...
    function u(e) {
        ...
        var n = {db: r(e), checkTime: Date.now()}, u = l.bind(null, e, n);
    ...
    var d = t.RECENT_SEARCH_OP = "recent_search", g = t.PIN_HIDDEN_ID_OP = "pin_hide"
}, function (e, t, n) {
    "use strict";
    ...
    function u(e, t, n, r, u, c) {
        var g = (0, d["default"])({state: t || "default"});
        return {
            signal: function (t, a) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.create = u;
    var c = n(66), d = r(c), g = n(7), m = n(31)
}, function (e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.createMutations = r, t.createModule = o, t.destroyModule = s;
    var l = n(135), u = window, c = u.addEvent, d = u.removeEvent
}, function (e, t, n) {
    var r = n(5), a = n(17), i = n(20);
    ...
    var r = n(46)("unscopables"), a = Array.prototype;
    ...
    for (var r = n(3), a = n(42), i = n(159), o = n(40), s = n(27), l = n(46), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m], _ = i[p], h = _ && _.prototype;
        if (h) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = {onNewMessagesChunk: n, onHistoryScroll: r}
}, function (e, t, n) {
    "use strict";
    ...
    function m(e, t) {
        var n = t.imQueue(e, !1), r = t.tabs[e], a = n.filter(function (n) {
    ...
    function b(e, t, n) {
        ...
        if (n.prevPeer = n.peer, n.peer = e, n.msgid = t || "", cur.peer = e, Jt({
            ...
            (0, jt.isTabLoaded)(n, e) && h(e, n, !0), a = n.tabbedPeers.map(function (e) {
                return e.peer
            }).indexOf(e) < 0 ? [{peer: e, type: "perm"}].concat(n.tabbedPeers) : n.tabbedPeers.map(function (t) {
    ...
    function w(e) {
        ...
        var n = e.tabs[t], r = [], a = (0, jt.isChatPeer)(t) && (n.data.closed || n.data.kicked),
    ...
    function C(e, t, n) {
        ...
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var t = Ot(e, 4), a = t[0], i = t[1], o = t[2], s = t[3];
    ...
    function E(e) {
        ...
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var r = Ot(n, 5), a = r[0], i = r[1], o = r[2];
    ...
    function T(e) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_get_key", uid: e.id, gid: e.gid}).then(function (t) {
            var n = Ot(t, 3), r = n[0], a = n[1], i = n[2];
            return extend({}, e, {imKey: r, imUrl: a, imPart: i})
        })
    }

    function S(e) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_get_ts", gid: e.gid}).then(function (t) {
            var n = Ot(t, 1), r = n[0];
            return extend({}, e, {imTs: r})
        })
    }
    ...
    function x(e, t) {
        var n = e.flags & Nt.FLAG_OUTBOUND, r = e.peerId;
    ...
    function N(e, t) {
        if ((0, jt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId], r = n.unread;
    ...
    function H(e, t, n) {
        function r(e, t) {
            return {id: e.messageId, text: e.text, date: e.date, kludges: e.kludges, authorName: t}
        }

        if (1 === e.length) {
            var i = e[0], o = (0, Gt.getMessage)(n, t, i), s = (0, Gt.getAuthorFullName)(n, t, i);
            return s === !1 ? n.set(Ie.bind(null, a({}, t, [o.userId]))).then(function (n) {
                var a = (0, Gt.getAuthorFullName)(n, t, i);
                return {msgIds: e, object: r(o, a)}
            }) : Promise.resolve({msgIds: e, object: r(o, s)})
        }
        return Promise.resolve({msgIds: e})
    }
    ...
    function j(e, t) {
        ...
        return t.tabs = Object.keys(e).reduce(function (n, r) {
            var a = t.tabs[r] ? t.tabs[r].msgs : {}, i = extend({}, a || {}, e[r].msgs || {});
    ...
    function Y(e, t) {
        if ((0, jt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId], r = t.imQueue(e.peerId).filter(function (t) {
    ...
    function X(e, t) {
        var n = {act: "a_get_media", id: e.messageId, gid: t.gid};
    ...
    function J(e, t, n) {
        var r = (0, jt.dayFromVal)(t), a = n.tabs[e];
    ...
    function ne(e, t, n, r) {
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var t = Ot(e, 3), n = t[0], a = t[1], i = t[2];
    ...
    function ie(e) {
        return function (t, n) {
            return e(n).then(function (e) {
                var r = t ? e.search(t) : e.list, a = r.map(ae);
    ...
    function oe(e, t) {
        ...
        return (0, Bt.retryFn)(Dt.post, 1, function () {
            return 4
        })(Dt.CONTROLLER, {act: "a_dialogs_preload", rs: a.join(","), gid: t.gid})["catch"](function (e) {
            return [[], [], []]
        }).then(function (e) {
            var a = Ot(e, 3), i = a[0], o = a[1], s = a[2];
    ...
    function le(e) {
        ...
        return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function (t) {
            ...
            var r = Ot(n, 4), a = r[0], i = r[1], o = r[2], s = r[3];
    ...
    function ue(e, t) {
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var r = Ot(n, 5), a = r[0], i = r[1], o = r[2], s = r[3], l = r[4];
    ...
    function ge(e, t) {
        if ((0, jt.isFullyLoadedTab)(t, e)) {
            var n = t.tabs[e];
            delete n.inplaceSearch, delete n.searchOffset, delete n.searchAllLoaded, delete n.searchText, delete n.searchDay, Jt({st: ""}), en()
        }
        return Promise.resolve(t)
    }
    ...
    function pe(e, t) {
        ...
        return Jt({st: n.searchText}), en(), (0, Dt.post)(Dt.CONTROLLER, {
            act: "a_search",
            q: a,
            from: "in",
            gid: t.gid,
            ...
            var t = Ot(e, 3), r = t[0], a = t[1], i = t[2];
            return n.searchOffset = a, n.searchAllLoaded = i, r
        })
    }

    function _e(e) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_important", offset: e, part: e > 0})
    }

    function he(e, t) {
        var n = (0, Gt.getTab)(e, t);
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_load_lastmsg", peerId: t, gid: e.get().gid}).then(function (r) {
            var a = Ot(r, 2), i = a[0], o = a[1];
    ...
    function be(e, t, n) {
        if ((0, jt.isFullyLoadedTab)(n, t)) {
            ...
            r.history = (0, jt.removeMessages)(e, u(r.history)), r.offset -= e.filter(function (e) {
                ...
                var t = (n.selectedMessages || []).indexOf(e);
                -1 != t && n.selectedMessages.splice(t, 1)
            })
        }
        return Promise.resolve(n)
    }
    ...
    function ye(e, t, n, r, a) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_mark", peer: t, hash: n, gid: a, msgs_ids: e.join(","), mark: r})
    }
    ...
    function Ee(e, t, n, r) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_restore", id: e, peer: t, hash: n, gid: r})
    }

    function ke(e, t, n) {
        return t && (n.pendingForward = null, e || (e = {msgIds: []}), t.addAttach("mail", e.msgIds.join(";"), e.object || null)), Promise.resolve(n)
    }
    ...
    function Ie(e, t) {
        ...
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_load_member", need: n}).then(function (e) {
            var n = Ot(e, 1), r = n[0];
    ...
    function Oe(e, t, n, r) {
        if ((0, jt.isFullyLoadedTab)(r, t)) {
            ...
            e.filter(function (e) {
                ...
                var i = (0, Gt.getMessage)(r, t, e), o = n ? i.flags | Nt.FLAG_IMPORTANT : i.flags & ~Nt.FLAG_IMPORTANT;
    ...
    function xe(e, t) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_spam", offset: e, gid: t, part: e > 0})
    }

    function Re(e, t) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_flush_spam", gid: t, hash: e})
    }
    ...
    function Be(e, t) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_owner_photo", photo: JSON.parse(e).data[0], peer: t})
    }
    ...
    function He(e, t, n) {
        return (0, Dt.post)("al_page.php", {act: "owner_photo_save", peer: e, _query: t}).then(function (e) {
            return n
        })
    }
    ...
    function Ue(e) {
        ...
        var n = Object.keys(e.tabs).length, r = e.active_tab;
        return (0, Dt.post)(Dt.CONTROLLER, {
            act: "a_resync",
            sel: e.peer,
            gid: e.gid,
            ...
            var i = Ot(n, 5), o = i[0], s = i[1], l = i[2], c = i[3], d = i[4];
            ...
            var g = e.peer, m = void 0;
            if ((0, jt.isReservedPeer)(g)) m = Promise.resolve(!1); else {
                var f = {tabs: a({}, g, e.tabs[g]), oCache: {}};
                m = j(a({}, g, o[g]), f)
            }
            return m.then(function (n) {
                e.tabs = o, e.admins = extend(e.admins, c), n && (e.tabs[g] = n.tabs[g], e.tabs[g].history = (0, jt.restoreQueue)(g, e, u(e.tabs[g].history))), e.loadingDialogs = !1, e.mutedPeers = l.mutedPeers, e.lastDialogsOptions = {has_more: l.has_more}, e.dialog_tab_cts = l.folder_cts, e.dialog_tabs[r] = d.map(intval);
    ...
    function Ye(e, t, n) {
        return function () {
            ...
            if (e) (0, Yt.setDocumentTitle)(e), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), e = !1; else {
                e = document.title;
                var a = r > 9 ? 10 : r;
    ...
    function Qe(e, t, n) {
        ...
        var r = document.title, a = window.devicePixelRatio >= 2 ? "_2x" : "";
    ...
    function Ze(e, t) {
        t.active_tab = e, (0, xt.updateLocation)({tab: e === Ut.FOLDER_ALL ? null : e});
        var n = [];
    ...
    function rt(e) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_get_mutex_key", gid: e})
    }

    function at(e, t) {
        return d(a({}, e, {free: !0}), t), (0, Dt.post)(Dt.CONTROLLER, {
            act: "a_block_release",
            peer: e,
            gid: t.gid
        }).then(function () {
    ...
    function st(e, t, n) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_spam_dialog", peer: e, gid: n.gid, hash: t})
    }

    function lt(e, t, n) {
        return n.tabbedPeers = e, (0, jt.isClassicInterface)(n) && (Jt({
            peers: n.tabbedPeers.filter(function (e) {
                var t = e.peer, r = e.type;
    ...
    function wt(e, t, n) {
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var t = Ot(e, 4), r = t[0], a = t[1], i = t[2], o = t[3];
            return i.forEach(function (e) {
    ...
    function Ct(e, t) {
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_reset_link", chat_id: e, write_hash: t.writeHash})
    }

    function Et(e) {
        return tn({invite_chat_id: null, invite_hash: null}), e.invitation = void 0, Promise.resolve(e)
    }
    ...
    function It(e, t, n) {
        var r = n.tabs[t], a = (0, Gt.getMessage)(n, t, e);
    ...
    function Mt(e, t, n, r) {
        var i = (0, Gt.getMessage)(e, n, t), o = i.userId;
        return (0, zt.oCacheGet)(r, o) ? Promise.resolve(r) : Ie(a({}, n, [o]), r)
    }

    function Lt() {
        ajax.post("al_im.php", {act: "a_hide_promo_tooltip"})
    }
    ...
    var Dt = n(33), xt = n(155), Rt = n(43), Nt = r(Rt), Bt = n(63), Ft = n(30), Ht = n(104), jt = n(7), Ut = n(31),
        Gt = n(152), qt = n(92), zt = n(121), Vt = n(61), Wt = n(77), Kt = n(54), Yt = n(117), Qt = t.TYPING_PERIOD = 5,
        Xt = 2e4, $t = 8, Zt = (0, xt.updateLazyLocation)(), Jt = Zt.scheduleNav, en = Zt.commitNav,
        tn = Zt.scheduleNavWithTimeOut, nn = t.ACTION_PRIORITIES = {
            block: 1,
            fav: 1,
            chat: 2,
            invite: 2,
    ...
    t.readLastMessages = l(function (e, t) {
        var n = t.tabs[e], r = Object.keys(n.msgs).map(function (n) {
        ...
        var r = Date.now() + rand(0, 100).toFixed(0), a = n.tabs[e];
        return (0, Bt.retryFn)(Dt.post, 1)(Dt.CONTROLLER, {
            ...
            var t = Ot(e, 1), r = t[0];
            return n.version !== r.version && nav.reload({force: !0}), n
        })
        ...
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            var r = t ? "mute" : "unmute";
            return window.Notifier && Notifier.lcSend("im", {act: r, peer: e}), n
        ...
        var n = Ut.FOLDER_MASKS[Ut.FOLDER_IMPORTANT], r = t.tabs[e].folders & n,
        ...
        var r = n.tabs[e];
        return (0, Dt.post)(Dt.CONTROLLER, {act: "a_get_message_local_id", chat: e, chat_local_id: t, hash: r.hash})
    })
}, function (e, t, n) {
    n(84), n(32), n(111), n(29), e.exports = n(148).Map
}, function (e, t, n) {
    var r = n(131), a = Math.max, i = Math.min;
    e.exports = function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.random = n;
    ...
    function l(e, t, n) {
        ...
        for (; n !== t && (t = t.parentNode);) if (ee(t, e)) return t;
        return null
    }
    ...
    function _(e) {
        return k(f("div", {innerHTML: e}))
    }

    function h(e) {
        return I(f("div", {innerHTML: e}))
    }
    ...
    function F() {
        var e = browser.msie6 ? r("PageContainer") : document.body, t = document.documentElement;
    ...
    function U(e) {
        ...
        if (t > 1) for (var n = 0; t > n; n++) U(arguments[n]); else if (e = r(e), e && e.style) {
            var a = e.olddisplay, i = "block", o = e.tagName.toLowerCase();
    ...
    function G(e) {
        var t = arguments.length;
        if (t > 1) for (var n = 0; t > n; n++) G(arguments[n]); else if (e = r(e), e && e.style) {
            var a = le(e, "display");
    ...
    function V(e, t, n) {
        e = r(e), n = n || 0;
        var a = Q(e)[1], i = $(e)[1], o = window, s = document.documentElement,
            l = Math.max(intval(o.innerHeight), intval(s.clientHeight)), u = r("page_header_cont"),
    ...
    function Q(e, t) {
        ...
        var n, a, i = {top: 0, left: 0}, o = e.ownerDocument;
    ...
    function $(e, t, n) {
        e = r(e);
        var a, i = [0, 0], o = document.documentElement;
        if (t && "border-box" === le(e, "boxSizing") && (t = !1), e == document) i = [Math.max(o.clientWidth, bodyNode.scrollWidth, o.scrollWidth, bodyNode.offsetWidth, o.offsetWidth), Math.max(o.clientHeight, bodyNode.scrollHeight, o.scrollHeight, bodyNode.offsetHeight, o.offsetHeight)]; else if (e) {
            var s = function () {
            ...
            if (q(e)) s(); else {
                var l = {position: "absolute", visibility: "hidden", display: "block"}, u = {}, c = !1;
        ...
        if (s.getComputedStyle) {
            ...
            o = e.currentStyle[t] || e.currentStyle[u], "auto" == o && (o = 0), o = (o + "").split(" "), each(o, function (t, n) {
                if (!/^\d+(px)?$/i.test(n) && /^\d/.test(n)) {
                    var r = e.style, a = r.left, i = e.runtimeStyle.left;
    ...
    function ue(e, t, n) {
        if (e = r(e)) {
            ...
            if ("opacity" == t) browser.msie && ((n + "").length ? 1 !== n ? e.style.filter = "alpha(opacity=" + 100 * n + ")" : e.style.filter = "" : e.style.cssText = e.style.cssText.replace(/filter\s*:[^;]*/gi, ""), e.style.zoom = 1), e.style.opacity !== n && (e.style.opacity = n); else try {
    ...
    function de(e, t, n) {
        ...
        var i = t + "-style-" + a, o = r(i), s = "._pseudo_" + a + ":" + t + "{";
        o || (o = headNode.appendChild(f("style", {id: i, type: "text/css"}))), each(n, function (e, t) {
            s += e + ": " + t + " !important;"
    ...
    function pe(e, t) {
        ...
        if (n) if (t) {
            if (vkCache[n]) {
                ...
                var r = 0;
                for (t in vkCache[n]) if ("__elem" !== t) {
                    r++;
                    break
                }
                r || pe(e)
    ...
    function he(e, t, n) {
        if (e = r(e), e && !e.titleSet) {
            if (t || (t = e), t.scrollWidth > t.clientWidth) e.setAttribute("title", n || e.innerText || e.textContent); else {
                var a = i("b", e);
    ...
    function ve() {
        var e = r("zoom_test_1") || document.body.appendChild(f("div", {id: "zoom_test_1"}, {
            left: "10%",
            position: "absolute",
            visibility: "hidden"
        })), t = r("zoom_test_2") || document.body.appendChild(f("div", {id: "zoom_test_2"}, {
    ...
    window.cf = function (e) {
        var t = e.createDocumentFragment(), n = e.createElement("div"), r = e.createRange && e.createRange();
    ...
    function r(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], n = e.split("_"), r = _(n, 2),
            a = r[0], i = r[1];
        return [a, i, t]
    }
    ...
    function a(e, t) {
        ...
        if (i > 50) return [[], e.length];
        for (var o = [], s = ""; n < e.length;) {
            var l = e[n];
            if ("id" === l) s = t[n]; else if ("," === l && s) o.push(r(s)), s = ""; else if ("(" === l) {
                var u = a(e, t, n + 1, i + 1), c = _(u, 2), d = c[0], g = c[1];
                n = g, o.push(r(s, d)), s = ""
    ...
    function o(e, t) {
        for (var n = void 0, r = 0, a = e; null !== (n = h.MESSAGE_REGEXP.exec(e));) {
            n = u(n);
            var i = n[0].length, o = n.index + i, s = e[n.index - 1], l = e[o - 1],
                d = void 0 !== s && /([\w\$А-Яа-яёЁєЄҐґЇїІіЈј\—\-\_@;.])/i.test(s),
                g = void 0 !== l && /([:;$])/i.test(l);
            if (!d && !g) {
                var m = c(n), f = m.domain;
    ...
    function u(e) {
        if (!e[0] || !e[6]) return e;
        var t = e[0].length - 1, n = e[6].length - 1;
        return "." === e[0][t] && "." === e[6][n] && (e[0] = e[0].slice(0, t), e[6] = e[6].slice(0, n)), e
    }

    function c(e) {
        return {full: e[0], protocol: e[1] || "http://", url: e[2], domain: e[4], query: e[6] || ""}
    }
    ...
    function f(e, t) {
        var n = t.protocol, r = t.url, a = t.query, i = t.domain, o = t.full;
        try {
        ...
        if (o.length > 55 && (o = o.substr(0, 53) + ".."), o = y(o).replace(/&amp;/g, "&"), !e && i.match(h.OUR_DOMAINS)) {
            ...
            var l = r, u = r.indexOf("#/"), c = "", d = void 0;
        ...
        var g = "away.php?utf=1&to=" + encodeURIComponent(n + w(r + a)), m = y((n + r + a).replace(/'/g, "\\'")),
    ...
    var h = n(31), v = void 0, b = window, y = b.clean, w = b.replaceEntities, C = b.statlogsValueEvent, E = {}
}, function (e, t, n) {
    var r = n(163);
    e.exports = function (e, t) {
        if (!r(e)) return e;
    ...
    var r = n(56)("meta"), a = n(163), i = n(129), o = n(5).f, s = 0, l = Object.isExtensible || function () {
        return !0
    }, u = !n(48)(function () {
    ...
    }, f = e.exports = {KEY: r, NEED: !1, fastKey: d, getWeak: g, onFreeze: m}
}, function (e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.oCacheExists = a, t.oCacheGet = i, t.oCacheAdd = o;
    var s = n(152)
}, function (e, t, n) {
    var r = n(159), a = n(148), i = n(40), o = n(42), s = n(26), l = "prototype", u = function (e, t, n) {
        var c, d, g, m, f = e & u.F, p = e & u.G, _ = e & u.S, h = e & u.P, v = e & u.B,
            b = p ? r : _ ? r[t] || (r[t] = {}) : (r[t] || {})[l], y = p ? a : a[t] || (a[t] = {}),
            w = y[l] || (y[l] = {});
        p && (n = t);
    ...
    function n(e) {
        l = l.reduce(function (t, n) {
            var r = s(n, 2), a = r[0], i = r[1], o = i(e);
            return o ? t : t.concat([[a, i]])
        }, [])
    }

    function r(e, t) {
        c === !1 && (c = !0, document.body.addEventListener("click", n, !0)), l = l.concat([[e, t]])
    }
    ...
    function i(e, t, n, r, a, i) {
        ...
        if ((0, E.isSearchingValue)(e, o)) {
            ...
            o ? (e.setState({recentSearch: !1}), a.stop()) : a.replaceOrAdd(s), cancelStackPush("im_search", s), o && e.set(C.setCurrentSearch.bind(null, o, !1)).then(t), addClass(r, "im-page--dialogs-search_fill"), addClass(r, "_im_d_search")
    ...
    function s(e, t, n) {
        var r = t().appendFastDialogs.bind(null, n), a = o(e, n, r);
    ...
    function l(e, t, n) {
        ...
        return x(.01, "im_search_stat", 1, "search_start"), (0, C.updateSearchQuery)(r), n.setState({recentSearch: !1}), r ? (n.get().dialog_search_going = !0, s(r, e, n).then(function (a) {
        ...
        })) : (e().restoreDialogs(n, !1, !0), Promise.resolve(!1))
    }

    function u(e, t, n, r) {
        var a = r.get(), i = o(e, r, t().appendDialogs.bind(null, r)), s = o(e, r, t().appendSearch);
        return (0, k.isPendingForward)(r) ? (0, C.searchHints)(e, n, "all", a).then(i) : Promise.all([(0, C.searchHints)(e, n, "all", a).then(i), (0, C.searchMessages)(e, a)]).then(function (e) {
            var t = w(e, 2), n = w(t[1], 2), a = n[0], i = n[1];
            s(r, a, i, !0)
        })
    }
    ...
    function g(e, t, n, r) {
        ...
        var o = a(t);
        uiSearch.reset(o), e.setState({recentSearch: !1}), i(e, r, t, o, n, o.value)
    }

    function m(e, t, n, r, a, i) {
        (0, E.isSearching)(e) ? (g(e, t, a, n), setTimeout(function () {
            return p(e, i)
        }, 10)) : (window.tooltips && tooltips.hide(i, {showsp: 0}), c(e, i, r))
    }
    ...
    function _(e, t, n) {
        ...
        e.set(C.toggleCommunityMute.bind(null, t)).then(function () {
            toggleClass(r, "im-page--gim-mute_muted", e.get().mute), t && v(e, {target: r})
        })
    }
    ...
    function h(e, t, n, r, a) {
        if (!(0, E.isSearching)(e)) {
            ...
            if (0 !== o.length || (0, D.doPopularSuggExist)(e)) {
                e.setState({recentSearch: !0}), i(e, function () {
    ...
    function v(e, t) {
        ...
        return showTooltip(n, {
            ...
            }, black: 1, shift: [13, 9], appendCls: "js-im-page"
        })
    }
    ...
    function b(e, t, n, r, i, o) {
        return {
            focusInput: function (t) {
                ...
                var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1, i = a ? o : function () {
                };
                d(t, e, r, i, n)
                ...
                var n = t.get().important_cnt, r = geByClass1(R, e);
    ...
    function y(e, t, n) {
        var r = geByClass1("_im_search_croll", e), o = a(e),
            s = (0, S["default"])("im_search", ["_im_search_croll", "_im_page_dcontent", "_im_d_search", "_im_dialog"]),
            c = (0, M.debouncedPromise)(u, 300), d = l.bind(null, n, c), g = i.bind(null, t, d, e, o, s),
            y = m.bind(null, t, e, d, n, s, r), w = f.bind(null, t, e, n),
            C = geByClass1("_im_dialogs_search_input", e);
        uiSearch.init(C, {onChange: g});
        var E = p.bind(null, t, r), T = geByClass1(N, e);
        o.value && g(o.value);
        var A = (0, I.createModule)({
            handlers: function (a, i) {
                if (a(geByClass1("_im_av_time", e), "mouseover", function (e) {
                    ...
                    var l = _.bind(null, t, !0), u = v.bind(null, t);
        ...
        return (0, k.isClassicInterface)(t) && _(t, !1, {target: T}), b(e, r, C, s, A, d)
    }
    ...
    t.mount = y;
    var C = n(113), E = n(152), k = n(7), T = n(123), S = r(T), I = n(106), A = n(137), M = n(63), L = n(43), P = n(36),
        O = n(104), D = n(152), x = debounce(A.statlogsProbValueEvent, 1e3), R = "_im_important_counter",
        N = "_im_gim_mute"
}, function (e, t, n) {
    var r = n(157), a = n(91);
    e.exports = function (e) {
    ...
    n(34);
    var a = n(89), i = n(66), o = r(i), s = n(93), l = n(43), u = n(113), c = n(121), d = n(7), g = n(61), m = n(99);
    window.IM = {
        init: function (e) {
            window.imwl = e.imwl, (0, g.startLoggingAllUnhandled)(), addTemplates(m), window.Promise || (window.Promise = s.Promise), window.cur.lang.dont_attach = getLang("mail_dont_add_media"), e.tabbedPeers = (e.tabbedPeers || []).map(function (e) {
                return {peer: e, type: "perm"}
            }), cur.ctrl_submit = e.ctrl_submit, cur.module = "im", cur.mutedPeers = e.mutedPeers, cur.gid = e.gid, cur.peer = e.peer, e.blockedFlagUpdates = {}, e.msgid = intval(nav.objLoc.msgid), cur.options = {blacklist_hash: e.thash};
            var t = 60 * (new Date).getTimezoneOffset(), n = -10800, r = n - t, i = e.timeshift;
    ...
    var r = n(47), a = n(75), i = n(125), o = n(119), s = n(129), l = n(103), u = Object.getOwnPropertyDescriptor;
    ...
    function i(e, t) {
        var n = t && t.msgs ? Object.keys(t.msgs) : [], a = n.filter(function (e) {
            return e > 0
        }).sort(function (e, t) {
            return t - e
        }).find(function (n) {
    ...
    function o(e, t, n) {
        var r = (0, d.convertKludgesToAttaches)(t.kludges, t.messageId), i = n.dData.attaches;
        if (a(t.text) !== n.dData.txt || r.length !== i.length) return !0;
        for (var o = r.length; o--;) if (r[o].id != i[o].id || r[o].type != i[o].type) return !0;
        return !1
    }
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.canMessageBeEdited = r, t.convertEmojiHtmlToRegularText = a, t.findLastMessageToEdit = i, t.wasMessageReallyModified = o, t.replaceMsgAfterEdit = s;
    var l = n(152), u = n(92), c = n(7), d = n(8)
}, function (e, t, n) {
    "use strict";
    var r = n(159), a = n(122), i = n(42), o = n(142), s = n(120), l = n(96), u = n(35), c = n(163), d = n(48),
        g = n(62), m = n(149), f = n(78);
    e.exports = function (e, t, n, p, _, h) {
        var v = r[e], b = v, y = _ ? "set" : "add", w = b && b.prototype, C = {}, E = function (e) {
            var t = w[e];
        ...
        if ("function" == typeof b && (h || w.forEach && !d(function () {
            ...
            var k = new b, T = k[y](h ? {} : -0, 1) != k, S = d(function () {
                k.has(1)
            }), I = g(function (e) {
                new b(e)
            }), A = !h && d(function () {
    ...
    function i(e, t) {
        var n = t.get(), r = n.peer, a = n.tabs[r].pinned;
        return 1 === e.length && a && e[0] === (0, D.parserMessage)(a).messageId
    }

    function o(e, t) {
        var n = e.get().peer, r = geByClass1("_im_page_peer_online", t);
    ...
    function s(e, t, n) {
        geByClass("_im_header_icon", e).forEach(function (e) {
            if (n.length > 0) hide(e); else if ("star" === domData(e, "type") && (0, P.isFoldersAvailable)(t) && (toggleClass(e, "im-page--header-icon_star-active", (0, P.isImportant)(t)), setStyle(e, {display: "inline-block"})), "answer" === domData(e, "type") && (0, P.isFoldersAvailable)(t) && (toggleClass(e, "im-page--header-icon_answer-shown", (0, P.isUnrespond)(t)), (0, P.isUnrespond)(t) ? setStyle(e, {display: "inline-block"}) : hide(e)), "search" === domData(e, "type") && !(0, P.isCommunityInterface)(t)) {
                var r = (0, P.isFullyLoadedTab)(t, t.get().peer) && t.get().tabs[t.get().peer].offset;
                setStyle(e, {display: "inline-block"}), toggleClass(e, "im-page-header-icon_search-shown", r)
            }
        })
    }
    ...
    function l(e, t, n) {
        ...
        m({actions: !0}, "im-page--chat-header"),
        ...
        var o = (0, D.getTab)(n, n.get().peer), s = geByClass1(G, e), l = a(t, n, n.get().peer), u = i(t, n),
    ...
    function u(e, t, n) {
        var a = t.get(), i = a.peer, o = a.tabs[i], l = clean(stripHTML(unclean(o.tab))), f = geByClass1(V, e),
            p = geByClass1(P.PINNED_CONTAINER_CLASS);
        f.tt = !1;
        var _ = (0, P.renderPhotosFromTab)(t, o, !0), h = getTemplate("im_simple_link", {
            href: o.href,
        ...
        var v = (0, P.isChatPeer)(i), b = v ? !o.data.closed && !o.data.kicked : 0, y = {
        ...
        if (v) {
            var w = (0, D.getPinnedMessage)(t), C = d(t);
            w && (0, N.isPinnedMessageVisibleInTab)(t, i) && (C ? t.set(L.loadChatMember.bind(null, r({}, i, [C]))).then(u.bind(null, e, t, n)) : y.pinned = !0)
        }
        var E = "";
        v ? E = b ? getTemplate("im_chat_members", {name: getLang("mail_im_n_chat_members", (0, P.getAliveMembersCount)(o))}) : "" : (0, P.isUserPeer)(i) && (E = (0, P.getLastSeenTextInHeader)(t, i));
        ...
        var T = val(p), S = c(t), I = geByClass1(H, e);
    ...
    function c(e) {
        var t = (0, D.getPinnedMessage)(e), n = geByClass1(P.PINNED_CONTAINER_CLASS);
    ...
    function p(e, t, n, r, o) {
        var s = e.get().selectedMessages, l = domData(o, "action"), u = e.get().peer, c = !0;
        switch (l) {
            case"delete":
                var d = vk.id == u && !e.get().gid, g = !d && e.get().delAllAllowed && s.every(function (t) {
            ...
            case"star":
                ...
                e.set(L.favMessage.bind(null, s, p, u)), e.get().longpoll.push(s.map(function (e) {
                    return {type: p ? O.SET_FLAGS : O.RESET_FLAGS, messageId: e, peerId: u, flags: O.FLAG_IMPORTANT}
                }));
                break;
            case"respond":
                (0, L.processFwd)(s, e.get().peer, e).then(function (t) {
                ...
                break;
            case"pin":
                var _ = (0, D.getLocalId)(e, s[0]), h = i(s, e),
                    v = h ? L.unpinMessageOptimistic.bind(null, u) : L.pinMessageOptimistic.bind(null, _, u),
                    b = h ? L.unpinMessage.bind(null, u) : L.pinMessage.bind(null, _, u), w = T.bind(null, t, u);
    ...
    function h(e, t, n) {
        var r = showFastBox({
            ...
            var i = gpeByClass("_im_invite_box", n.target), o = geByClass1(Q, i), s = geByClass1("_im_invite_new", i);
    ...
    function v(e, t, n) {
        if ((0, P.isChatPeer)(t)) {
            var r = e.get().tabs[t].name, a = _.bind(null, e, t, r, n), i = showFastBox({
                title: getLang("mail_chat_topic_change_title"),
                dark: 1
            }, getTemplate("im_chat_change_topic", {value: r}), getLang("global_save"), function (e, t) {
                var n = a(o, t);
                n && i.hide()
            }, getLang("global_cancel"), function () {
                i.hide()
    ...
    function b(e, t, n, r, a, i) {
        var o = domData(i, "action"), s = geByClass1(j, r).parentNode, l = e.get().peer;
        switch (o) {
            case"clear":
            ...
            case"photos":
            case"media":
                showWiki({w: "history" + (0, P.convertPeerToUrl)(l) + "_photo"}, null, {});
                break;
            case"topic":
                v(e, l, t);
                break;
            ...
            case"leave":
                ...
                break;
            case"invite_link":
                var g = h.bind(null, e, l), m = !1, f = !1, p = !1, _ = function () {
                    elfocus(m, 0, m.value.length), document.execCommand("copy"), setStyle(f, {opacity: 1}), p && (p = clearTimeout(p)), p = setTimeout(function () {
                        return setStyle(f, {opacity: 0})
                    }, 2e3)
                }, b = !1, y = !1;
                showBox("al_im.php", {act: "a_get_invite_link", chat_id: l - 2e9}, {
                    onDone: function (e) {
            ...
            case"chat":
            case"invite":
                if ((0, P.isChatPeer)(l)) (0, P.inviteUser)(e, l, t, L.setCreationType); else if ((0, P.isUserPeer)(l)) {
                    var C = e.get().tabs[l], E = [[l, C.tab]];
    ...
    function w(e, t, n, r) {
        var a = (0, P.isClassicInterface)(e), i = void 0, o = void 0;
    ...
    function C(e, t, n) {
        var r = (0, P.isClassicInterface)(e), a = domData(n.target, "action");
    ...
    function E(e, t) {
        var n = e.get(), r = n.selectedMessages, o = n.peer;
        switch (t) {
            case"pin":
    ...
    function k(e, t, n, r, a) {
        ...
        switch (i) {
            case"star":
                ...
                break;
            case"search":
                n().showSearch(e), window.tooltips && tooltips.hide(a, {fasthide: !0});
                break;
            case"answer":
                var o = (0, D.getTab)(e, e.get().peer);
                o && (e.set(L.markDialogAnswered.bind(null, e.get().peer, o.lastmsg)), showDoneBox(getLang("mail_marked_as_answered"), {out: 1e3}), e.get().longpoll.push([(0, O.resetPeer)()]))
        }
    }
    ...
    function S(e, t, n, r) {
        return {
            changeActions: function (t) {
                var n = geByClass1(j, e), r = geByClass1(U, e), a = t.get().curActions,
    ...
    function I(e, t, n) {
        var r = (0, M.createMutations)(S), a = r.callMutations, i = r.bindMutations, o = p.bind(null, t, n, a),
            s = b.bind(null, t, n, a, e), l = y.bind(null, t, n, a), u = function (e, n) {
                return (0, P.showVerifiedTooltip)(n, t.get().peer)
            }, c = w.bind(null, t, e), d = C.bind(null, t, e), g = k.bind(null, t, e, n), m = function (r) {
    ...
    t.mount = I;
    var M = n(106), L = n(113), P = n(7), O = n(43), D = n(152), x = n(92), R = n(121), N = n(77), B = n(54),
        F = "_im_action", H = "_im_page_peer_name", j = "_ui_menu", U = "_im_dialog_action_wrapper",
        G = "_im_mess_actions", q = "_im_page_action", z = "_im_chat_topic_change_input", V = "_im_chat_verified",
        W = "im-page--chat-header_chat", K = "_im_page_peer_name", Y = "_im_chat_members", Q = "_im_chat_invite_link",
    ...
    function n(e) {
        ...
        if (t) {
            var n = t[e.type];
            if (n) for (var r = void 0, a = 0; a < n.length; a++) {
                var s = i(n[a], 2), l = s[0], u = s[1], c = void 0;
    ...
    var r = n(4), a = n(46)("iterator"), i = n(27);
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.statlogsValueEvent = n, t.randEnabled = r, t.statlogsProbValueEvent = a
}, , function (e, t, n) {
    var r = n(27), a = n(46)("iterator"), i = Array.prototype;
    e.exports = function (e) {
    ...
    function l(e, t, n) {
        var r = geByClass1(q, n), a = t.get().selection.length, i = "add_member" === e.get().creationType, o = a > 0,
            s = a > 1;
    ...
    function u(e, t, n, r, a, i, o) {
        if (o) {
            var s = intval(domData(o, "list-id")), u = g(i), c = trim(o.textContent), d = geByClass1(j, t),
                m = getSize(d)[1], f = void 0;
            inArray(s, u) ? (f = r.removeSelection(s, c), removeClass(o, "olist_item_wrap_on")) : (f = r.addSelection(s, c), addClass(o, "olist_item_wrap_on")), f.then(function () {
                var e = m - getSize(d)[1], t = a.scrollTop();
                a.scrollTop(t - e)
            }), l(e, i, t);
    ...
    function c(e, t) {
        var n = g(e), r = ["_im_dialog", "_im_dialog" + t.peerId, "im-creation--item"], a = [];
    ...
    function p(e, t, n, r, a) {
        var o = geByClass1(j, e), s = void 0, l = void 0, u = (0, S.searchLocalHints)(r, t.get()),
    ...
    function h(e, t, n, r) {
        var a = r.get(), i = d(a), o = a.selection.map(function (e) {
            return e.id
        });
    ...
    function v(e, t, n, r) {
        ...
        cur.recieveCropResult = function (n) {
            cur.recieveCropResult = !1, curBox() && curBox().hide(), e.set(S.presetAvatar.bind(null, n)), (0, S.getOwnerPhoto)(n, a).then(function (e) {
                geByClass1(U, t).appendChild(ce("img", {className: "im-chat-placeholder--img " + V, src: e}))
    ...
    function w(e, t, n, r, i, o, l) {
        ...
        var c = g(t), d = e.get(), m = geByClass1(q, n), f = uiSearch.getFieldEl(geByClass1(H, n)).value;
    ...
    function E(e, t) {
        var n = 70, r = t && t.get().selection.length;
        return {top: -1, bottom: (0, M.isClassicInterface)(e) ? r > 0 ? n - 1 : 0 : -1}
    }
    ...
    function k(e, t, n, r, i, s, l, c) {
        return {
            show: function (t) {
                ...
                t.setState({shown: !0}), o(e, !0), cancelStackPush("im_create", l), addClass(e, "im-create_shown"), a && a.forEach(function (e) {
    ...
    function T(e, t, n) {
        var r = (0, D["default"])({selection: []}), o = geByClass1(N, e),
            s = (0, A.mount)(o, (0, D["default"])({offset: 0, limit: K, elements: [], elCls: B}), function () {
                return {
                    idFn: function (e) {
                        return intval(e.peerId)
                    }, hoverableFn: function (e) {
                        return hasClass(e, "_im_dialog")
                    }, renderFn: c.bind(null, r), more: function (e, n) {
                        var a = void 0;
        ...
        var g = geByClass1(j, e), m = (0, L.mount)(g, r, function () {
                return {
                    selectionDeleted: function (n, r) {
                        l(t, n, e), removeClass(geByClass1("_im_dialog" + r), "olist_item_wrap_on")
                    }, onChange: h.bind(null, t, e, s)
                }
            }), p = a.bind(null, t, e, n, "cross", m, r), E = _.bind(null, t, e, n, s, r, m), T = v.bind(null, t, e),
            I = b.bind(null, t, e), M = y.bind(null, t, r, e, s, m, n), O = w.bind(null, t, r, e, s, m, n),
            x = geByClass1(R, e), H = (0, P.createModule)({
                handlers: function (t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = T;
    var S = n(113), I = n(152), A = n(24), M = n(7), L = n(94), P = n(106), O = n(66), D = r(O), x = n(43),
        R = "_im_create_cancel", N = "_im_create_list", B = "_im_dialog", F = "_im_create_tab",
        H = "_im_dialogs_creation_name", j = "_im_create_select", U = "_im_create_avatar",
        G = "_im_create_remove_avatar", q = "_im_confirm_creation", z = "_im_cancel_creation", V = "_im_avatar_img",
        W = ["im-creation--item_hovered"], K = 100
}, function (e, t, n) {
    var r = n(42);
    e.exports = function (e, t, n) {
    ...
    function a(e, t, n) {
        var r = gpeByClass("_im_mess", n), a = intval(domData(r, "msgid")), o = e.get().peer,
            s = (0, p.getMessage)(e, o, a), l = !(0, f.isImportant)(s);
    ...
    function i(e, t, n, a) {
        ...
        r(e, a, i ? 84 : 34, i ? "im-star-tt_long" : "im-star-tt", function () {
            var t = domData(gpeByClass("_im_mess", a), "msgid"), n = (0, p.getMessage)(e, e.get().peer, t);
            return n ? (0, f.isImportant)(n) ? getLang("mail_im_unmark_important") : getLang("mail_im_toggle_important") : ""
        })
    }

    function o(e, t, n) {
        var r = e.get().peer, a = +domData(domClosest("im-mess", n.target), "msgid");
    ...
    function l(e, t, n, r) {
        var a = intval(domData(gpeByClass("_im_mess", r), "msgid")), i = (0, p.getMessage)(e, e.get().peer, a);
    ...
    function d(e, t, n) {
        var r = i.bind(null, t, 0), d = a.bind(null, t), g = s.bind(null, t, 0), m = o.bind(null, t, n),
            f = u.bind(null, t), p = l.bind(null, t, n), h = (0, _.createModule)({
                handlers: function (t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.mount = d;
    var g = n(113), m = n(7), f = n(92), p = n(152), _ = n(106), h = n(43), v = n(77), b = "_im_mess_fav",
        y = "_im_mess_reply", w = "_im_mess_edit"
}, function (e, t) {
}, function (module, exports, __webpack_require__) {
    "use strict";

    function uploadFailed(e, t, n) {
        var r = void 0 !== t.ind ? t.ind : t, a = t.fileName ? r + "_" + t.fileName : t;
        ...
        if (!i) {
            ...
            setTimeout(showFastBox({title: getLang("global_error")}, o).hide, 2e3)
        }
    ...
    function onAnyUploaded(e) {
        var t = void 0 !== e.ind ? e.ind : e, n = (e.fileName || e.filename || "").replace(/[&<>"']/g, ""),
            r = n ? t + "_" + n : e, a = ge("upload" + r + "_progress_wrap");
        return a && hide(geByClass1("progress_x", a)), r
    }

    function onPhotoUploaded(e, t, n, r) {
        var a = onAnyUploaded(e);
        ajax.post("al_photos.php", extend({act: "choose_uploaded"}, t), {
            onDone: function (e, t) {
                r().choose("photo", e, extend(t, {upload_ind: a}))
            }, onFail: uploadFailed.bind(null, r, e)
        })
    }

    function onDocUploaded(e, t, n, r) {
        var a = onAnyUploaded(e), i = {act: "a_save_doc", from: "choose", mail_add: 1};
        n.opts.imhash && (i = extend(i, {
            from_place: "from_gim",
            imhash: n.opts.imhash
        })), ajax.post("docs.php", extend(i, t), {
            onDone: function (e, t, n) {
                r().choose("doc", e + "_" + t, extend(n, {upload_ind: a}))
            }, onFail: uploadFailed.bind(null, r, e)
        })
    }
    ...
    function showDropbox(e) {
        var t = geByClass1(DROPBOX_CLASS), n = geByClass1("im-page--chat-header").getBoundingClientRect(),
    ...
    function parseOnUploadProgress(e, t, n) {
        return {loaded: t, total: n, fileName: e.fileName ? e.fileName.replace(/[&<>"']/g, "") : void 0}
    }
    ...
    function initPhotoUploader(e, t, n, r) {
        var a = t.get().upload_opts, i = geByClass1("_im_upload_photo"), o = geByClass1("_im_drop_photo");
    ...
    function initDocUploader(e, t, n) {
        var r = t.get().upload_doc_opts, a = geByClass1("_im_upload_doc"), i = geByClass1("_im_drop_doc");
    ...
    function mount(e, t, n) {
        ...
        var r = initDocUploader(e, t, n), a = initPhotoUploader(e, t, n, r);
    ...
    Object.defineProperty(exports, "__esModule", {value: !0}), exports.mount = mount;
    var _modules = __webpack_require__(106), DROPBOX_CLASS = "_im_upload_dropbox"
}, function (e, t) {
    e.exports = function () {
    ...
    "use strict";
    var r = n(5).f, a = n(41), i = (n(40), n(142)), o = n(26), s = n(35), l = n(91), u = n(96), c = n(13), d = n(64),
        g = n(37), m = n(154), f = n(120).fastKey, p = m ? "_s" : "size", _ = function (e, t) {
            var n, r = f(t);
    ...
    var n = e.exports = {version: "2.2.1"};
    "number" == typeof __e && (__e = n)
}, function (e, t, n) {
    var r = n(5).f, a = n(129), i = n(46)("toStringTag");
    e.exports = function (e, t, n) {
    ...
    function r(e, t) {
        var n = domData(t, "chat-id"), r = domData(t, "hash");
    ...
    t.mount = a;
    var o = n(113), s = n(106), l = n(43), u = "_im_join_chat"
}, function (e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.getNativeOption = a, t.setNativeOption = i, t.createScroll = o;
    var s = n(106), l = function () {
        function e(t, n) {
            var a = this;
        ...
        return e.prototype.update = function () {
            ...
            var t = this.scrollTop(), n = t - this.prevScroll, r = this.contHeight();
        ...
        function e(t, n) {
            ...
            r(this, e), this.prevTop = 0, this.scroll = new uiScroll(t, {
                ...
                onscroll: function (e) {
                    var t = a.scrollTop(), r = a.prevTop - t;
    ...
    function c(e, t, n) {
        ...
        var i = Math.min(n, a), o = Math.max(n, a);
    ...
    function d(e, t) {
        var n = a(t), r = s(n, e), i = 0;
        for (var o in r.msgs) if (r.msgs.hasOwnProperty(o)) {
            var l = v(t, e, o);
    ...
    function f(e, t) {
        var n = a(e), r = n.msg_local_ids_sort && n.msg_local_ids_sort[t];
        return "undefined" != typeof r ? 2e9 + r : t
    }

    function p(e, t, n) {
        var r = s(e, t), a = v(e, t, n), i = Object.keys(r.msgs).filter(function (n) {
            var r = v(e, t, n), i = r.local && r.type !== z.EDIT_MESSAGE;
    ...
    function v(e, t, n) {
        var r = s(e, t), a = r && r.msgs && r.msgs[n];
        return a ? _(a) : null
    }

    function b(e, t, n) {
        var r = s(e, t), a = r && r.msgs && Object.keys(r.msgs).sort(function (e, t) {
            return +e - t
        });
        if (!a) return null;
        var i = a && a.indexOf("" + n), o = i > -1 ? a[i - 1] : null;
        return r.msgs[o]
    }
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.unpackStore = a, t.getFirstUnread = i, t.getPeer = o, t.getTab = s, t.getCurrentTab = l, t.getSelectedMessages = u, t.getMessageRangeFromSelection = c, t.countUnread = d, t.getMessageByRid = g, t.isRidExist = m, t.getLocalId = f, t.getLastMessage = p, t.parserMessage = _, t.getAuthorFullName = h, t.getMessage = v, t.getPreviousMessage = b, t.isClassicInterface = y, t.isLocksAvailable = w, t.isFoldersAvailable = C, t.isCommunityInterface = E, t.getBareTab = k, t.isReversedDialogs = T, t.isFullyLoadedTab = S, t.makeTabNotFullyLoaded = I, t.isGoToEndVisible = A, t.getUnreadScrollBottom = M, t.isSendingAvailable = L, t.isCommunityPeer = P, t.isCommunityBlocked = O, t.checkVoiceMessageAvailable = D, t.isSearching = x, t.getSearchText = R, t.isSearchingValue = N, t.isRecentSearchesActive = B, t.getPinnedMessage = F, t.doPopularSuggExist = H, t.isAnyMessageBeingEdited = j, t.getGroupId = U, t.getTabDraft = G;
    var q = n(92), z = n(43), V = r(z), W = n(31), K = n(7), Y = n(121), Q = n(8)
}, , function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.updateLocation = n, t.updateLazyLocation = r;
    var a = window, i = a.nav, o = a.extend
}, , function (e, t, n) {
    var r = n(162);
    ...
    function T(e, t) {
        if (c(e) || "undefined" == typeof e.length) {
            for (var n in e) if (Object.prototype.hasOwnProperty.call(e, n) && t.call(e[n], n, e[n]) === !1) break
        } else for (var r = 0, a = e.length; a > r; r++) {
            var i = e[r];
    ...
    function S(e, t, n) {
        for (var r = n || 0, a = (e || []).length; a > r; r++) if (e[r] == t) return r;
        return -1
    }
    ...
    function M(e) {
        var t, n, r = {}, a = 1, i = arguments.length, o = arguments;
        for (t in e) {
    ...
    function L() {
        var e, t = arguments, n = t[0] || {}, r = 1, a = t.length, i = !1;
        for ("boolean" == typeof n && (i = n, n = t[1] || {}, r = 2), "object" === ("undefined" == typeof n ? "undefined" : N(n)) || s(n) || (n = {}); a > r; ++r) if (null != (e = t[r])) for (var o in e) {
            var l = n[o], u = e[o];
    ...
    function O(e, t) {
        var n = window.templates = window.templates || {}, r = n[e];
    ...
    function D(e) {
        ...
        var t = {}, n = function (t) {
            ...
            if (r.name) if ("text" != r.type && r.type) if (r.getAttribute("bool")) {
                var a = val(r);
                if (!a || "0" === a) return;
                t[r.name] = 1
            } else t[r.name] = browser.msie && !r.value && e[r.name] ? e[r.name].value : r.value; else t[r.name] = val(r)
        };
    ...
    function x(e, t) {
        for (var n, r = t ? F : B, a = []; e && (n = e.match(r));) {
            ...
            var i = 0;
            n[4] || (i = 7), a.push({url: n[2 + i], query: n[5 + i] || "", domain: n[4 + i]})
        }
        return a
    }
